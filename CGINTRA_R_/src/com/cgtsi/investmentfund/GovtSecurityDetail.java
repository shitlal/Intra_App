...
/*************************************************************
   *
   * Name of the class: GovtSecurityDetail
   * This class encapsulates the various details of investment in Government
   * Securities.
   *
...
public class GovtSecurityDetail
{
	...
	*/
	...
	/**
	* Access method for the seriesName property.
	*
	* @return   the current value of the seriesName property
	*/
	...
	*
	* @param seriesName the new value of the seriesName property
	*/
	public void setSeriesName(String aSeriesName)
	{
