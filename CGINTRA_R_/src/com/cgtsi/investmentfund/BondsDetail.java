...
/*************************************************************
   *
   * Name of the class: BondsDetail
   * This class encapsulates the various details of investment in  Bonds.
   *
...
public class BondsDetail
{
	...
	*/
	...
	/**
	* Access method for the bondName property.
	*
	* @return   the current value of the bondName property
	*/
	...
	*
	* @param bondName the new value of the bondName property
	*/
	public void setBondName(String aBondName)
	{
	  bondName = aBondName;
	}
   ...
   public void setInvestmentReferenceNumber(String string) {
	 ...
	 * @param i
	 */
	public void setNumberOfSecurities(int i) {
