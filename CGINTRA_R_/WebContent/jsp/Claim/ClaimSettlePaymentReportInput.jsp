...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form	action="/ClaimSettlePaymentReport.do?method=ClaimSettlePaymentReport"
		method="POST"  >
		<TR>
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
							...
							<TR>
								...
								<TD align="left" valign="middle" class="TableData" colspan="3">
									<html:select  property="status">
									    <html:option value="MA" >Maker saved for Initiated</html:option>
									    <html:option value="MI" >Maker Initiated</html:option>
									    <html:option value="RA" >Reviewer Approved</html:option>
									    <html:option value="CA" >Checker Approved</html:option>
									    <html:option value="CAPB" >Checker Approved Claim Settled Data for Payment Bank</html:option>
									    <!--<html:option value="AD" >Accout Credited to MLI account</html:option>
									    <html:option value="TAD" >Accout TO BE Credited to MLI account</html:option>-->
									</html:select>                                                                  
								</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ClaimSettlePaymentReport.do?method=ClaimSettlePaymentReport')">
