					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD class="Heading">Payment Initiated For Reviewer Approval</TD>
									<td class="Heading" >&nbsp;
										...
										<!-- <%=value.get(i)==null?"--":value.get(i)%>-->
											    <%
											     if(value.get(i)==null){
											    	 ...
											    	 if(i==position_payid){%>
											           <a href="ShowPaymentAllocatedMLIWiseData.do?method=ShowPaymentAllocatedMLIWiseData&PayId=<%=value.get(position_payid)%>&approvalStatus=MI"><%=value.get(i)%></a>	 
                                                    <%
											    	 }else{%>
                                                       <%=value.get(i)%>											    		 
											    	 <%}
				...
				<TR>
					...
					<table cellspacing=5 cellpadding=5>
						<tr>
							...
							<td>
								<a href="ClaimSettleForPayment.do?method=ExportToFile&&fileType=CSVType&FlowLevel=CK1">
								<IMG src="images/csv_icon.png" width="50" height="35" alt="Export to Excel">
								</a>
							</td>
							
							<td>
								<input type="button" value=" Approve Initiated Payment " onClick="Saving('approve');">
							</td>
							
							<td>
								<input type="button" value=" Return Initiated Payment " onClick="Saving('return');">
							</td>
							
							<td>
								<a href="ClaimSettleForPayment.do?method=ExportToFile&&fileType=PDFType&FlowLevel=CK1">
					...
					<DIV align="center"><A	href="javascript:submitForm('ClaimSettlePaymentSavedMLIWiseCK1Input.do?method=getClaimSettlePaymentSavedMLIWiseCK1Input')">
