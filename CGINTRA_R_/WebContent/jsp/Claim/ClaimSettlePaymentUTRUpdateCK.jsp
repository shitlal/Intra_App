...
function Saving(actiontype){
     ...
     if(totSelectCnt!=0){
		     if(actiontype=="approve"){
				if(confirm(" Total Cgpan Selected : "+totSelectCnt+" \n Total Net Outstanding Amount : "+totNetAmt+" \n\n !! Are you Sure for Approve for  Payment !! " )){      
					  submitForm('ClaimSettlePaymentUTRUpdateCKApproval.do?method=ClaimSettlePaymentUTRUpdateCKApproval&actionType=Approve');
					  document.getElementById("AppUTRButton").disabled = true;		    	 
		    	 ...
		    	 if(confirm(" Total Cgpan Selected : "+totSelectCnt+" \n Total Net Outstanding Amount : "+totNetAmt+" \n\n !! Are you Sure for Return for Payment !! " )){
		    	      
					  submitForm('ClaimSettlePaymentUTRUpdateCKApproval.do?method=ClaimSettlePaymentUTRUpdateCKApproval&actionType=Reject')
		              return true;
				}else{
				...
				alert("!!Please Select atleast One case for UTR Detail Update !! ");
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD class="Heading">Payment Initiated For Final Approval</TD>
									<td class="Heading" >&nbsp;
						...
						<logic:iterate id="object" name="claimSettleForPaymentForm" property="colletralCoulmnName"	indexId="index">
							...
							%>		
								...
								<%if(str.equals("PAY ID")){
								    	   position_payid=columnCount-1;
								   }
								   
								 if(str.equals("AMOUNT")){
									 position_amt=columnCount-1;
						     }
							...
							<TR>								
								        ...
								        <TD width="10%" align="left" valign="top"
											...
											<% String id = "checkboxfield("+value.get(position_payid)+")";
											   String param=value.get(position_amt).toString();
											   String jsfuncName="CalculateTotSelectedCntAndAmt('"+param+"',this);";
											%>
											    
											    <input type="hidden" id="netAmt"+<%=value.get(position_payid)%> value="<%=value.get(position_amt)%>"  >											     
				...
				<TR>
				    <TD height="20">&nbsp;
				       <table cellpadding=10 cellspacing=10 >
							...
							<TD height="20">Total Amount Selected</TD>
				...
				<TR>
					...
					<table cellspacing=5 cellpadding=5>
						<tr>
							...
							<td>
								<a href="ClaimSettleForPayment.do?method=ExportToFile&&fileType=EXLType&FlowLevel=UTRUpdateCKData">
								<IMG src="images/csv_icon.png" width="50" height="35" alt="Export to Excel">
								</a>
							</td>
							
							<td>
								<input type="button" id="AppUTRButton"  value=" Approve For UTR Update " onClick="Saving('approve');">
								<input type="hidden" value=" To maintain element Count"><br>
								<div id="processing" style="display: none;">!!Please Wait....!!</div>
							</td>
							
							<!-- <td>
								<input type="button" value=" Return Payment  " onClick="Saving('return');">
							</td>-->
							
							<td>
								<a href="ClaimSettleForPayment.do?method=ExportToFile&&fileType=PDFType&FlowLevel=CK2">
					...
					<DIV align="center">
					<A	href="javascript:submitForm('ClaimSettlePaymentUTRUpdateCKInput.do?method=ClaimSettlePaymentUTRUpdateCKInput')">
					   <IMG src="images/Back.gif" alt="Print" width="49" height="37"	border="0">
					</A> 
