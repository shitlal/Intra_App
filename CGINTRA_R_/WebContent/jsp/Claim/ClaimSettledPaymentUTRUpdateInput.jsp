...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:form action="ClaimSettledPaymentUTRUpdateProcess.do?method=ClaimSettledPaymentUTRUpdateProcess"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<TD>
					 <A target="_blank" href="ClaimSettleForPayment.do?method=getBulkUploadTemplate" >
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ClaimSettledPaymentUTRUpdateProcess.do?method=ClaimSettledPaymentUTRUpdateProcess')">
