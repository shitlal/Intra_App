...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form	action="/ClaimSettleForPayment.do?method=getClaimSettleForPayment"		method="POST"  >
		<TR>
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ClaimSettleForPaymentMliWise.do?method=ClaimSettleForPaymentMliWise')">
