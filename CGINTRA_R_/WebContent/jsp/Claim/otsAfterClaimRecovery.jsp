...
<% session.setAttribute("CurrentPage","RecoveryAfterOTS.do?method=getRecoveryAfterOTS");%>
        ...
        function Validation()
        {
         if(document.forms[0].cp_ots_enterMember.value=="" ||document.forms[0].cp_ots_enterMember.value.length < 12 )
        {
        alert("Please Enter Member Id of Correct Length ");
                 document.forms[0].target ="_self";
                 document.forms[0].method="POST";
                 document.forms[0].action="/cgtsi-ViewController-context-root/RecoveryAfterOTS.do?method=getRecoveryAfterOTS";
                 document.forms[0].submit();
        }
      else if(document.forms[0].cp_ots_enterCgpan.value !="" && document.forms[0].cp_ots_enterCgpan.value.length < 13)
        {
      ...
      else if (document.forms[0].cp_ots_appRefNo.value !="" && document.forms[0].cp_ots_appRefNo.value.length < 15)
      {
      ...
      else if (document.forms[0].cp_ots_appRefNo.value == "" && document.forms[0].cp_ots_enterCgpan.value == "")
      {
        ...
        document.forms[0].target ="_self";
        document.forms[0].method="POST";
        document.forms[0].action="/cgtsi-ViewController-context-root/RecoveryAfterOTS.do?method=getRecoveryAfterOTSDetail";
        document.forms[0].submit();
        }	
        }
        </SCRIPT>
...
<table width="725" border="0" cellpadding="0" cellspacing="0">
 <html:errors/>
 <html:form action="RecoveryAfterOTS.do?method=getRecoveryAfterOTS"
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
         ...
         <tr align="left" valign="top">
          ...
          <td align="left" valign="top" class="TableData" colspan="4">
           <html:text property="cp_ots_enterMember" size="20" alt="MemberID"
                      maxlength="12" name="cpRecoveryOTS" onkeyup="isValidNumber(this)" onkeypress="return numbersOnly(this, event)" />
          </td>
         </tr>
         <tr align="left" valign="top">
          <td align="left" valign="top" class="ColumnBackground">
          ...
          <td align="left" valign="top" class="TableData">
           <html:text property="cp_ots_appRefNo" size="20" maxlength="15"
                      name="cpRecoveryOTS"/>
           &nbsp;&nbsp;&nbsp;&nbsp;
           <bean:message key="or"/>
          </td>
          ...
          <td align="left" valign="top" class="TableData">
           <html:text property="cp_ots_enterCgpan" size="20" maxlength="13" alt="CGPAN"
                      name="cpRecoveryOTS"/>
          </td>
         </tr>
        </table>
