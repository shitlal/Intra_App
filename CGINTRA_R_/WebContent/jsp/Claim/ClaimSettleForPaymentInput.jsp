...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form	action="/ClaimReviewReportInput.do?method=getClaimReviewReportInput"
		method="POST"  >
		<TR>
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TR>
								...
								<TD align="left" valign="top" class="ColumnBackground">
									<DIV align="center"><font color="#FF0000" size="2">*</font> &nbsp;<bean:message key="toDate" />
								</TD>
							...
							<TR>
								...
								<TD align="left" valign="top" class="ColumnBackground">
								<DIV align="center">&nbsp;Account Detail</DIV>
								</TD>
								<TD align="left" valign="middle" class="TableData" colspan="3">
									<html:select  property="status">
									    <html:option value="A" >Available</html:option>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ClaimReviewReportInput.do?method=getClaimReviewReportInput')">
