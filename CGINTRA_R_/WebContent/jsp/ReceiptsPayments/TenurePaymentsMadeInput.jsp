...
<% session.setAttribute("CurrentPage","appropriateTenurePaymentsInput.do?method=getPaymentMadeForTenureInput");%>
...
<script type="text/javascript">
	function getPaymentsMadeForGF(){
		...
		document.forms[0].action = 'appropriatePaymentstenure.do?method=getPaymentsMadeForTenure';
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="appropriatePaymentstenure.do?method=getPaymentsMadeForTenure" method="POST">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								 <A href="javascript:submitForm('appropriatePaymentstenure.do?method=getPaymentsMadeForTenure')">
