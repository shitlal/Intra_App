...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="submitClaimASFPaymentsnew.do" method="POST" enctype="multipart/form-data">
		...
		<TR>
                   ...
                   <TD align="left" valign="top" class="ColumnBackground">
									...
									<TD align="left" valign="top" class="ColumnBackground">
										...
										<!-- <bean:message key="instrumentDt" /> --> Short/Excess Amt
                                                                        ...
                                                                        <TD align="left" valign="top" class="ColumnBackground">
										<!-- <bean:message key="instrumentDt" /> --> Remarks 
									</TD>
                                                                        <TD align="left" valign="top" class="ColumnBackground">
										<!-- <bean:message key="instrumentDt" /> --> Appropriate
									</TD>
                          ...
                          <%=date1%>
													...
													<html:text property="<%=name%>"   onkeypress="return numbersOnly(this, event)"  size="10"  name="rpAllocationForm" value=""/>
												</TD>
														...
														<html:text property="<%=name%>"  name="rpAllocationForm" size="10"   onkeypress="return numbersOnly2(this, event)"  value="" maxlength="10"/><font color='red'>(DD/MM/YYYY)</font>     
			...
			<TD width="20" background="images/TableVerticalRightBG.gif">
                ...
                <TR>
					...
					<DIV align="center">
				 	<A href="javascript:submitForm('submitClaimASFPaymentsnew.do?method=submitClaimASFPaymentsnew')">
