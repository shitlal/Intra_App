...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="getPPDateWiseDetails.do?method=getPPDateWiseDetails" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<%
									    RPActionForm rpForm = (RPActionForm)session.getAttribute("rpAllocationForm") ;
									    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd/MM/yyyy");									    
									    java.util.Date fromDate = (java.util.Date)rpForm.getFromDate(); 
									    String fromDateStr = sdf.format(fromDate);
									    java.util.Date toDate = (java.util.Date)rpForm.getToDate();
									    String toDateStr = sdf.format(toDate);
									%>
									   <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="fromDate" size="20" value="<%=fromDateStr%>" maxlength="10" alt="Reference" name="rpAllocationForm"/>
									...
									<DIV align="center">
									    ...
									    <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="toDate" size="20" value="<%=toDateStr%>" maxlength="10" alt="Reference" name="rpAllocationForm"/>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm('getPPDateWiseDetails.do?method=getPPDateWiseDetails')">
