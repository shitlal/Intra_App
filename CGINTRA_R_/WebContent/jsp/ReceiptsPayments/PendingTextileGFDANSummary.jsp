...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="gfallocatePaymentsforTextile.do?method=submitTextileGFDANPayments" method="POST" >
		<TR> 
        ...
        ssiname = danSummary.getUnitname();
          ...
          <%=danSummary.getBranchName()%>
					...
					<TD align="left" valign="top" class="tableData">
							<a href="javascript:setHiddenFieldValue('danNo', '<%=danNo%>', 'gfallocatePaymentsforTextile.do?method=getTextileGFPANDetails');">
						<%=danNo%>
						<%name="danIds(key-"+i+")";%>
          ...
          <TD align="left" valign="top" class="tableData">
               ...
               <A onclick ="" href="javascript:if(checkbox_checker()) submitForm('gfallocatePaymentsforTextile.do?method=submitTextileGFDANPayments')">
          		  <IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>
