...
<% session.setAttribute("CurrentPage","gfallocatePaymentsforTextile.do?method=submitTextileGFDANPayments");
String danNo ;
int danIndex = 0;
...
String remarks ;
 ...
 String toDate=dateFormat.format(systemdate);
 // System.out.println("toDate:"+toDate);
%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <html:errors />
<html:form action="gfallocatePaymentsforTextile.do?method=gfallocatePaymentsforTextile" method="POST" focus="modeOfPayment">
        ...
        <tr>
		  ...
		  <tr>
            ...
            <tr>
              ...
              <td class="tableData"><table cellpadding="0" cellspacing="0">
                ...
                <!--  <td><html:text property="paymentDate" size="20" alt="Payment Date" name="rpAllocationForm" maxlength="10"/></td> -->
                 <td class="tableData"><html:text property="paymentDate" size="20" alt="Payment Date" name="rpAllocationForm" value="<%=toDate%>" maxlength="10"/></td>
            ...
            <td class="tableData"><bean:write name="rpAllocationForm" property="instrumentNo"/></td>
            </tr>
            <tr>
              ...
              <td class="tableData"><table cellpadding="0" cellspacing="0">
                <tr>
                 <td><html:text property="instrumentDate" size="20" alt="Instrument Date" name="rpAllocationForm" value="<%=toDate%>" maxlength="10"/></td> 
               <!--  <td class="tableData"><bean:write name="rpAllocationForm" property="instrumentDate"/></td> -->
              <!--    <td><img src="images/CalendarIcon.gif" width="20" align="center"
        ...
        <tr align="center" valign="baseline">
          <td>
			<a href="javascript:submitForm('gfallocatePaymentsforTextile.do?method=gfallocatePaymentsforTextile');"><img src="images/Save.gif" alt="Save"
