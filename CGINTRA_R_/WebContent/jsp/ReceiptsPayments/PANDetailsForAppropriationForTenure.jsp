...
<%session.setAttribute("CurrentPage","appropriatePaymentstenure.do?method=getPaymentDetailsForTenure");%>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<%if (index==0) {
										...
										RPActionForm form = (RPActionForm)session.getAttribute("rpAllocationForm");
										form.setInstrumentNo(instrumentNo);
										%>
										<TR>
										<TD align="left" valign="top" colspan="12">
											<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
												<TR>
										            ...
										            <%=instrumentNo%>
										            <%--<html:text name="rpAllocationForm" property="instrumentNo" value="<%=instrumentNo%>"/> --%>
										            <%} %>
										            </TD>
													...
													<%--<html:text name="rpAllocationForm" property="instrumentDate" value="<%=dateFormat.format(instrumentDate)%>"/> --%>
													<%}%>
													</TD>
												</TR>
...
--%>
				<TR>
					...
					<DIV align="center">
					<A href="javascript:setChkHiddenValue('<%=(index-1)%>','appropriatedFlags', 'appropriatedFlags','appropriatePaymentstenure.do?method=appropriatePaymentsForTenure','Y', 'N');">
