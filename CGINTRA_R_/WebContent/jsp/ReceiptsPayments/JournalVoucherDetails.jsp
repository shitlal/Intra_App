...
<% session.setAttribute("CurrentPage","showJournalVoucherDetails.do?method=showJournalVoucherDetails");%>
<body onload="javascript:dispTotalAmountJV()">
<html>
<html:errors />
<html:form action="insertJournalVoucherDetails.do?method=insertJournalVoucherDetails" method="POST" focus="deptCode">
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
								<TR>
									<TD>
										<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
											<TR>
												<TD width="25%" class="JVHeading"><bean:message key="journalVoucher" /></TD>
												<TD><IMG src="images/JVTriangleSubhead.gif" width="19" height="19"></TD>
											</TR>
											<TR>
												<TD colspan="3" class="JVHeading"><IMG src="images/Clear.gif" width="5" height="5"></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
										...
										<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
											<TR>
												...
												<TD colspan="2" align="left" valign="top" class="ColumnBackground">
													<bean:message key="bankGLCode" />
												</TD>
												<TD class="tableData" >
													<html:select name="rpAllocationForm" property="bankGLCode" >
														<html:option value="">Select </html:option>
														<html:options name="rpAllocationForm" property="glHeads"/>
													</html:select>
												</TD>
												<TD colspan="2" align="left" valign="top" class="ColumnBackground">
												<bean:message key="bankGLName"/>
												</TD>
												<TD class="tableData" colspan="2">
													<html:text property="bankGLName" size="30" alt="Bank GL name" name="rpAllocationForm"/>
												</TD>

												<TD align="left" valign="top" class="ColumnBackground">
													<bean:message key="deptSecCode"/>
												</TD>
												<TD class="tableData" >
											...
											<TR>
												...
												<TD class="tableData">
													<html:text property="<%=voucherAmountRsKey%>" size="15" name="rpAllocationForm" maxlength="16"  onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" onblur="javascript:dispTotalAmountJV()"/>
												</TD>
...
<!--													<img src="images/CalendarIcon.gif" width="20" align="center" onClick="<%=instrumentCal%>">-->
												...
												<TD class="tableData">
													<html:text property="<%=voucherInstrumentNoKey%>" size="20" maxlength="10" name="rpAllocationForm" /><%if(((size-1)==counter) && isRequired==null){%><a href="javascript:submitForm('addMoreJournalVoucherDetails.do?method=addMoreJournalVoucherDetails')">AddMore</a><%}%>
												</TD>
											</TR>
...
<!--													<img src="images/CalendarIcon.gif" width="20" align="center" onClick="<%=advCal%>">-->
												...
												<TD class="tableData">
													<html:text property="<%=voucherInstrumentNoKey%>" size="20" maxlength="10" name="rpAllocationForm"/><a href="javascript:submitForm('addMoreJournalVoucherDetails.do?method=addMoreJournalVoucherDetails')">AddMore</a>
												</TD>
											</TR>
											<%}%>
											<TR>
								...
								<TR align="center" valign="baseline">
									<TD>
									<a href="javascript:submitForm('insertJournalVoucherDetails.do?method=insertJournalVoucherDetails');"><img src="images/Save.gif" alt="Save"
