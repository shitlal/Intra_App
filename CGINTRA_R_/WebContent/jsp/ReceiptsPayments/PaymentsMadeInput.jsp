...
<% session.setAttribute("CurrentPage","appropriatePaymentsInput.do?method=getPaymentMadeInput");%>
...
<script type="text/javascript">
	function getPaymentsMadeForGF(){
		...
		document.forms[0].action = 'appropriatePayments.do?method=getPaymentsMade';
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="appropriatePayments.do?method=getPaymentsMade" method="POST">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								 <A href="javascript:submitForm('appropriatePayments.do?method=getPaymentsMade')"> 
