...
<%session.setAttribute("CurrentPage","gfallocatePaymentsforTextile.do?method=getTextileGFPANDetails");
String name;
int i = 0;
String fDisbDate;
...
<body>
	...
	<html:form name="rpAllocationForm" type="org.apache.struts.validator.DynaValidatorActionForm" action="submitTextileGFPANPayments.do?method=submitGFPANPayments" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
...
<%--								<TD align="left" valign="top" class="TableData">
						...
						<TR>
							<TD align="center" valign="baseline" colspan="8">
								<DIV align="center">
									<A href="javascript:submitForm('submitTextileGFPANPayments.do?method=submitGFPANPayments')">
