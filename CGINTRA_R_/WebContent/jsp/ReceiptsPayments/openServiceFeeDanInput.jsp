...
<%
	session.setAttribute("CurrentPage","openServiceFeeDanInput.do");
%>

<html:errors />
<html:form action="openServiceFeeDans.do?method=openServiceFeeDans" method="POST" enctype="multipart/form-data">
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<table width="661" border="0" cellspacing="1" cellpadding="0">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD colspan="6" class="Heading"><IMG
					...
					<table width="661" border="0" cellspacing="1" cellpadding="1">
						<tr align="left">
							...
							<div align="left"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message
								key="selectMember" /></div>
							</td>
							<td class="TableData" width="343">
							<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <html:text
								property="memberId" size="20" alt="member id"
								name="rpAllocationForm" maxlength="12"  onkeypress="return decimalOnly(this, event,13)"
				...
				<TR>
					...
					<DIV align="center"><A href="javascript:submitForm('openServiceFeeDans.do?method=openServiceFeeDans')">
