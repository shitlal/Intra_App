...
<% session.setAttribute("CurrentPage","claimappropriatePaymentsnew.do?method=getPaymentsMadeForCLAIMNew");%>
...
<script type="text/javascript">
	function getPaymentsMadeForGF(){
		...
		document.forms[0].action = 'claimappropriatePaymentsnew.do?method=getPaymentsMadeForCLAIMNew';
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="claimappropriatePaymentsnew.do?method=getPaymentsMadeForCLAIMNew" method="POST">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								 <A href="javascript:submitForm('claimappropriatePaymentsnew.do?method=getPaymentsMadeForCLAIMNew')">
