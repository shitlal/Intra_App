...
<%
	...
	session.setAttribute("CurrentPage",
			"gfallocatePayments.do?method=getPendingGFDANs");
%>
<%
	String sdanDate;
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form name="rpAllocationForm"
		...
		action="gfallocatePayments.do?method=submitGFDANPayments"
		method="POST">
		<TR>
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="1"
				...
				<TR>
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR>
							...
							<TD><IMG src="images/TriangleSubhead.gif" width="29"
								height="19"></TD>
						</TR>
						<TR>
				...
				<TR>
					...
					<TD align="left" valign="top" class="tableData" colspan="8"><bean:write
				...
				<TR>
					...
					Included Service Tax</TD>
					<TD width="10%" align="left" valign="top" class="ColumnBackground">
					Included Ecess</TD>
					<TD align="left" valign="top" class="ColumnBackground">
					Included S & H Ecess</TD>
					<TD align="left" valign="top" class="ColumnBackground">
					Included S.B Ecess</TD>
					<!-- kuldeep@path 24-5-16 -->
					<TD align="left" valign="top" class="ColumnBackground">
					Included Krishi Kalyan Cess</TD>
				...
				<logic:iterate id="object" name="rpAllocationForm"
					...
					<TR>
						...
						<TD align="left" valign="top" class="tableData"><!--<a href="javascript:setHiddenFieldValue('danNo', '<%=danNo%>', 'gfallocatePayments.do?method=getGFPANDetails');">-->
						<%=danNo%></TD>
						...
						%> <%=balanceValue%></TD>
						<TD align="left" valign="top" class="tableData"><%=amountBeingPaid%>


						</TD>


						<TD align="left" valign="top" class="tableData"><%=danSummary.getInclSTaxAmnt()%>
						</TD>
						<TD align="left" valign="top" class="tableData"><%=danSummary.getInclECESSAmnt()%>
						</TD>
						<TD align="left" valign="top" class="tableData"><%=danSummary.getInclHECESSAmnt()%>
						</TD>

						
						<TD align="left" valign="top" class="tableData"><%=danSummary.getKrishiKalCess()%>
						</TD>
						...
						<TD align="left" valign="top" class="tableData">
						<%
							thiskey = danNoKey + ClaimConstants.CLM_DELIMITER1
												+ balanceValue;
										checkboxKey = "appropriatedFlags(" + thiskey + ")";
										// checkboxKeyId = "depositedFlags("+inwardId+")";
						%> <html:checkbox name="rpAllocationForm"
							property="<%=checkboxKey%>" value="Y" /> <!--html:checkbox property="<%=name%>" alt="Pay" name="rpAllocationForm" value="Y"/-->
						</TD>
				...
				<TR>
					...
					<td valign="top" class="ColumnBackground" colspan="4">
				...
				<TR>
					...
					<A onclick=""
						href="javascript:if(checkbox_checker()) submitForm('gfallocatePayments.do?method=submitGFDANPayments')">
