...
<% session.setAttribute("CurrentPage","daywisegfbatchappropriation.do?method=daywisegfbatchappropriation");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="daywisegfbatchappropriatePayments.do?method=daywisegfbatchappropriatePayments" method="POST" enctype="multipart/form-data">
			<TR> 
                ...
                <TD width="69%"><IMG src="images/TriangleSubhead.gif" width="19" height="19"></TD>
							...
							<tr align="left"> 
								<td  class="ColumnBackground"> 
									&nbsp;									
									<font color="#FF0000" size="2">*</font>	&nbsp;<bean:message key="dateOfRealisation" />
								</td>
									<td  class="TableData">
					...
					<TR >
						<TD align="center" valign="baseline">
							<DIV align="center">
								<A href="javascript:submitForm('daywisegfbatchappropriatePayments.do?method=daywisegfbatchappropriatePayments')"><IMG src="images/OK.gif" alt="Save" width="49" height="37" border="0"></A>	
