...
<% session.setAttribute("CurrentPage","recoveryappropriatePaymentsInput.do?method=getPaymentMadeForRecoveryInput");%>
...
<script type="text/javascript">
	function getPaymentsMadeForGF() {
		...
		document.forms[0].action = 'showRecoveryPaymentDetailsforAppropriation.do?method=showRecoveryPaymentDetailsforAppropriation';
		document.forms[0].submit();
</script>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="recoveryappropriatePaymentsInput.do?method=getPaymentMadeForRecoveryInput"
				...
				<TR>
					...
					<table width="661" border="0" cellspacing="1" cellpadding="0">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR>
									<TD width="32%" class="Heading">Appropriation Detail</TD>
									<TD><IMG src="images/TriangleSubhead.gif" width="22"
										height="19"></TD>
								</TR>
								<TR>
									<TD colspan="8" class="Heading"><IMG
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<html:select property="bankName"   style="width:77%;">
								...
								<html:option value="CHAITANYA GODAVARI GRAMEENA BANK">CHAITANYA GODAVARI GRAMEENA BANK</html:option>
								<html:option value="CHATTISGARH RAJYA GRAMIN BANK">CHATTISGARH RAJYA GRAMIN BANK</html:option>
								...
								<html:option value="ETAWAH KSHETRIYA GRAMIN BANK">ETAWAH KSHETRIYA GRAMIN BANK</html:option>
								<html:option value="EXPORT IMPORT BANK OF INDIA">EXPORT IMPORT BANK OF INDIA</html:option>
								...
								<html:option
									value="JAMMU & KASHMIR DEVELOPMENT FINANCE CORPORATION LIMITED">JAMMU & KASHMIR DEVELOPMENT FINANCE CORPORATION LIMITED</html:option>
								...
								<html:option value="KAVERI GRAMEENA BANK">KAVERI GRAMEENA BANK</html:option>
								...
								<html:option value="MADHYA BIHAR GRAMIN BANK">MADHYA BIHAR GRAMIN BANK</html:option>
								...
								<html:option value="PRAGATHI KRISHNA GRAMEENA BANK">PRAGATHI KRISHNA GRAMEENA BANK</html:option>
								...
								<html:option value="SYNDICATE BANK">SYNDICATE BANK</html:option>
								<html:option value="TAMILNAD MERCANTILE BANK LTD">TAMILNAD MERCANTILE BANK LTD</html:option>
								<html:option value="TELANGANA GRAMIN BANK">TELANGANA GRAMIN BANK</html:option>
								...
								<html:option
									value="THE TAMILNADU INDUSTRIAL INVESTMENT CORPORATION LIMITED">THE TAMILNADU INDUSTRIAL INVESTMENT CORPORATION LIMITED</html:option>
						...
						<tr align="left">
							...
							<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <html:text
								property="dateOfTheDocument24" size="10" maxlength="10"
								name="rsForm" /> <img src="images/CalendarIcon.gif"
								alt="" width="20"
								onClick="showCalendar('rsForm.dateOfTheDocument24')"
								align="center"></div>
							</td>
							<td class="ColumnBackground" width="207">
							<div align="center">*&nbsp;<bean:message key="toDate" /></div>
							</td>
							<td class="TableData" width="343">
							<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <html:text
								property="dateOfTheDocument25" size="10" maxlength="10"
								name="rsForm" /> <img src="images/CalendarIcon.gif"
								alt="" width="20" onClick="showCalendar('rsForm.dateOfTheDocument25')" align="center"></div>
							</td>
						</tr>
					...
					<DIV align="center"><A
						href="javascript:submitForm('showRecoveryPaymentDetailsforAppropriation.do?method=showRecoveryPaymentDetailsforAppropriation')">
