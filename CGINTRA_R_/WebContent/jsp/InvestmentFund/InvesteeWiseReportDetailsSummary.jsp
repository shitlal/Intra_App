...
<% session.setAttribute("CurrentPage","investeeWiseReportDetailsSummary.do?method=investeeWiseReportDetailsSummary");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="investeeWiseReportDetailsSummary.do?method=investeeWiseReportDetailsSummary" method="POST" enctype="multipart/form-data">
		<TR> 
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<%
										  ...
										  String intr = df.format(pReport.getInterest());
									...
									%>
											...
											<TD width="10%" align="left" valign="top" class="ColumnBackground1">						
											<%=pReport.getTenureType()%>
											</TD>
											<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
											<%   java.util.Date utilDate=pReport.getDepositDate();
											...
											<TD width="10%" align="left" valign="top" class="ColumnBackground1">
											<%   java.util.Date utilDate1=pReport.getMaturityDate();
													if(utilDate1 != null)
													{
