...
<% session.setAttribute("CurrentPage","investmentMaturityReportDetails.do?method=investmentMaturityReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="investmentMaturityReportDetails.do?method=investmentMaturityReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
								...
								<TR>
									...
									%>
											...
											<%=formatedDate3%>
												...
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">		
												<div align="right">
												<% sum=investment.getInvestmentAmount();
