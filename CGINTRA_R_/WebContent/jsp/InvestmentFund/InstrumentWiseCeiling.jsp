...
<% session.setAttribute("CurrentPage","showInstrumenetWiseCeiling.do?method=showInstrumenetWiseCeiling");%>

<html:form action="setInstrumentWiseCeiling.do?method=setInstrumentWiseCeiling" method="POST" focus="instrumentName">
  ...
  <tr> 
	...
	<tr>
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpInstrumentWiseCeiling.do?method=helpInstrumentWiseCeiling')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
            ...
            <td height="162"> <table border="0" cellspacing="1" cellpadding="0" height="112">
                <tr> 
                  <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<bean:message key="instCatWiseExp" /> Ceiling
						</td>
                ...
                <tr>
                  ...
                  <td class="tableData" width="474" height="25"> <div align="left"> 
                      <html:select name="ifForm" property="instrumentName" onchange="javascript:submitForm('fetchInstrumentWiseCeiling.do?method=fetchInstrumentWiseCeiling')">
                      <html:option value="">Select </html:option>
                      <html:options name="ifForm" property="instrumentCategories"/>
                      </html:select>
                    </div></td>
                </tr>
		<TR>
  ...
  <tr> 
      ...
      <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
        <div>
          <div align="center"><html:link href="javascript:submitForm('setInstrumentWiseCeiling.do?method=setInstrumentWiseCeiling')"><img src="images/Save.gif" alt="Ok" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Reset" width="49" height="37" border="0"></html:link></div>
      </div></td>
