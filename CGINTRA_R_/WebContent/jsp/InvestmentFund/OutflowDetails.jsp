...
<% session.setAttribute("CurrentPage","showOutflow.do");%>

<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	<html:errors />
	<html:form action="showBudgetOutflowDetails.do?method=showBudgetOutflowDetails" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpOutflowDetails.do?method=helpOutflowDetails')">
			    HELP</A>
			</DIV>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('showBudgetOutflowDetails.do?method=showBudgetOutflowDetails')">
