...
<% session.setAttribute("CurrentPage","showBudgetOutflowDetails.do?method=showBudgetOutflowDetails");%>

<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	<html:errors />
	<html:form action="setBudgetInflowDetails.do?method=setBudgetInflowDetails" method="POST" enctype="multipart/form-data" name="investmentForm" 
	type="com.cgtsi.actionform.investmentForm" focus="annualFromDate">
		...
		<TR>
			...
			<TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpAnnualOutflowDetails.do?method=helpAnnualOutflowDetails')">
			    HELP</A>
			</DIV>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
									...
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												...
												<bean:message key="outflowDetails" /></TD>
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData">
										...
										&nbsp<a href="javascript:submitForm('getAnnualBudgetOutflowDetails.do?method=getAnnualBudgetOutflowDetails')"><bean:message key="getBudgetOutflowDetails"/> </a>
									</TD>
								</TR>
								<%
									int noOfHeads=0;
