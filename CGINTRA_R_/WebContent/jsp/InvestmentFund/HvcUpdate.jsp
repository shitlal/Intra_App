...
<% session.setAttribute("CurrentPage","hvcUpdate.do?method=hvcUpdate");%>
								...
								<TR>
									<TD colspan="12"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="28%" class="Heading"><bean:message key="hvcHeader" /></TD>
									...
									%>
											...
											<% String value1 = cheque.getChequeNumber(); 
											  String url = "hvcUpdatePage.do?method=hvcUpdatePage&number="+value1;%>
											<html:link href="<%=url%>"><%=value1%></html:link>
											</TD>

											<td class="HeadingBg" width="15%"><div align="left"></div>
											...
											<td class="HeadingBg" width="15%"><div align="left"></div><%=cheque.getToBankName()%></td>
											...
											<td class="tableData" width="15%"><div align="left"></div>
											<%sum=cheque.getChequeAmount();
											totalSum = totalSum + sum;%>
											<%=decimalFormat.format(sum)%>
											</td>
											...
											<td class="tableData" width="15%"><div align="left"></div><%=cheque.getToBankName()%></td>
