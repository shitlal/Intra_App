...
<% session.setAttribute("CurrentPage","showCumulativeProjection.do?method=showPeriodicProjection");%>

<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	<html:errors />
	<html:form action="getCumulativeProjectionDetails.do?method=getCumulativeProjectionDetails" method="POST" enctype="multipart/form-data" focus="endDate">
	<tr>
		<td><br></td>
	</tr>
    <tr>
    ...
    <tr>
	  ...
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpCumulativeProjectClaimDetails.do?method=helpCumulativeProjectClaimDetails')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
                ...
                <tr >
                  <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<bean:message key="CumulativeProjection" /></td>
          ...
          <tr >
            <td align="center" valign="baseline" > <div align="center"><html:link href="javascript:submitForm('getCumulativeProjectionDetails.do?method=getCumulativeProjectionDetails')"> <img src="images/OK.gif" alt="OK" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Cancel" width="49" height="37" border="0"></html:link>
              </div></td>
          </tr>
        </table></td>
