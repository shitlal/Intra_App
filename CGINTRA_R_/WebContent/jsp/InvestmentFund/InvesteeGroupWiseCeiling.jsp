...
<% session.setAttribute("CurrentPage","showInvesteeGroupWiseCeiling.do?method=showInvesteeGroupWiseCeiling");%>

<html:form action="setInvesteeGroupWiseCeiling.do?method=setInvesteeGroupWiseCeiling" method="POST" focus="investeeGroup">
  ...
  <tr> 
	...
	<tr>
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpInvesteeGroupWiseCeiling.do?method=helpInvesteeGroupWiseCeiling')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
            ...
            <td height="162"> <table border="0" cellspacing="1" cellpadding="0" height="112">
                <tr> 
                  <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<bean:message key="investeeGroupWiseCeiling" /> 
						</td>
                ...
                <tr>
                  ...
                  <td class="tableData" width="474" height="25"> <div align="left"> 
                      <html:select name="ifForm" property="investeeGroup" onchange="javascript:submitForm('fetchInvestGrpWiseCeiling.do?method=fetchInvestGrpWiseCeiling')">
  ...
  <tr> 
      ...
      <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
        <div>
          <div align="center"><html:link href="javascript:submitForm('setInvesteeGroupWiseCeiling.do?method=setInvesteeGroupWiseCeiling')"><img src="images/Save.gif" alt="Save" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Reset" width="49" height="37" border="0"></html:link></div>
      </div></td>
