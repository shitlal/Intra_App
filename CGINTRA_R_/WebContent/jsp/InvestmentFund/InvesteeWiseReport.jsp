...
<% session.setAttribute("CurrentPage","investeeWiseReport.do?method=investeeWiseReport");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="investeeWiseReport.do?method=investeeWiseReport" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									%>
											...
											<% String name = pReport.getInvestee(); 
												   String url = null;	
											if(!(name == null  || name.equals("null") || name.equals("")))
											{
											   url = "investeeWiseReportDetails.do?method=investeeWiseReportDetails&investee="+name;
											 %>
											<html:link href="<%=url%>"><%=name%></html:link>
											<%
											}
											%>
											</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('investeeWiseReportInput.do?method=investeeWiseReportInput')">
