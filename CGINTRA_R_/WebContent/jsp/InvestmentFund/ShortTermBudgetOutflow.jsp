...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<html:form action="setBudgetInflowDetails.do?method=setBudgetInflowDetails" method="POST" >
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpShortTermOutflowDetails.do?method=helpShortTermOutflowDetails')">
			    HELP</A>
			</DIV>
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData" colspan="2">
										<html:select property="month" name="investmentForm" onchange="javacript:submitForm('getShortTermBudgetOutflowDetails.do?method=getShortTermOutflowDetails')">
								...
								<TR>
									...
									<TD class="ColumnBackground" height="25">
										<b>&nbsp;<bean:message key="amountOutflow" /></b>
									</TD>
								</TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('setShortTermBudgetOutflowDetails.do?method=setShortTermBudgetOutflowDetails')">
