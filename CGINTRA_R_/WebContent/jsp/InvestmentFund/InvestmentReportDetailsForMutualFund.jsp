						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="mutualFundName"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
									...
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="parValueRs"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="navOnDateOfPurchase"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="navAsOnDate"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="isinNumber"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="openOrClose"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="dateOfSelling"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="schemeNature"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="entryLoadRs"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="exitLoadRs"/>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="markToMarket"/>
									</TD>
									...
									%>
											...
											<%=formatedDate3%>
												...
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="right">
												<%=investment.getCurrentDateNav()%>
													
												  </div>
												</TD>
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="left">
												<%=investment.getIsinNumber()%>
												 </div>
												</TD>
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="left">
												<%=investment.getOpenClose()%>
												  </div>
												</TD>
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="left">
												<%   java.util.Date utilDate2= 		investment.getSellingDate();
											...
											<%=formatedDate2%>
												...
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="right">
												<%entryLoad=investment.getEntryLoad();	
												  totalEntryLoad = entryLoad + totalEntryLoad;%>		<%=decimalFormat.format(entryLoad)%>	

												 </div>
												</TD>
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="right">
												<%exitLoad=investment.getExitLoad();
												  totalexitLoad = exitLoad + totalexitLoad;%>			<%=decimalFormat.format(exitLoad)%>	

												  </div>
												</TD>
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">	
												<div align="left">
												<%=investment.getMarkToMarket()%>	
												 </div>
												</TD>
											</TR>
											</logic:iterate>
									...
									<TD align="left" valign="top" class="ColumnBackground">
									<div align="right">
									<%=decimalFormat.format(totalEntryLoad)%>
									</div>
									</TD>
									<TD align="left" valign="top" class="ColumnBackground">
									<div align="right">
									<%=decimalFormat.format(totalexitLoad)%>
									</div>
									</TD>
									<TD align="left" class="ColumnBackground"> 
									</TD>
