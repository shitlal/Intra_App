...
<% session.setAttribute("CurrentPage","showAnnualFundsOutflowDetails.do?method=showAnnualFundsOutflowDetails");%>
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpAnnualFundsOutflowDetails.do?method=helpAnnualFundsOutflowDetails')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
            ...
            <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
				<TR align="left" valign="top">
					...
					<TD align="left" valign="top" class="TableData">
						...
						<a href="javascript:submitForm('getFundsOutflowDetails.do?method=getFundsOutflowDetails')">Get Outflow Details</a>
					</TD>
				</TR>
                <!-- <tr>
				...
				<%
					...
					%>
						...
						<TR align="left" valign="top">
							...
							<TD align="left" valign="top" class="TableData">
						<html:text name="investmentForm" property="<%=subHeadsName%>" size="20" maxlength="16" onkeypress="return decimalOnly(this, event, 13)" onkeyup="isValidNumber(this)"/> &nbsp;<bean:message key="inRs" />
							</TD>
						</TR>
					<%
							}
