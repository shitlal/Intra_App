...
<% session.setAttribute("CurrentPage","fdDetailsForDeposit.do?method=fdDetailsForDeposit");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="fdDetailsForDeposit.do?method=fdDetailsForDeposit" method="POST" enctype="multipart/form-data">
		<TR> 
