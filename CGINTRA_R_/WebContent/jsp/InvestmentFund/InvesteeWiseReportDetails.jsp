...
<% session.setAttribute("CurrentPage","investeeWiseReportDetails.do?method=investeeWiseReportDetails");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="investeeWiseReportDetails.do?method=investeeWiseReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									%>
											...
											<% String number = pReport.getInvestmentNumber(); 
											  String url = "investeeWiseReportDetailsSummary.do?method=investeeWiseReportDetailsSummary&investee="+number;%>
											<html:link href="<%=url%>"><%=number%></html:link>
											</TD>
