...
<% session.setAttribute("CurrentPage","showInflowForecastDetails.do?method=showInflowForecastDetails");%>
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="23" align="left" valign="bottom"><img src="images/TableRightTop.gif.gif" width="23" height="31"></td>
    </tr>
    <tr> 
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="35%" class="Heading">&nbsp;<bean:message key="inflowDetailsHeading"/></td>
          ...
          <tr align="center" valign="baseline"> 
            <td> <div align="center">
			<A href="javascript:submitForm('setInflowForecastDetails.do?method=setInflowForecastDetails')">
