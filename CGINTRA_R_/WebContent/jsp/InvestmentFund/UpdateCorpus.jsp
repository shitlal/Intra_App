...
<% session.setAttribute("CurrentPage","showUpdateCorpusMasterScreen.do?method=showUpdateCorpusMaster");%>

<html:form action="showUpdateCorpusMaster.do?method=showCorpusList" method="POST" enctype="multipart/form-data" focus="corpusFromDate">
  ...
  <tr> 
	...
	<tr>
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpUpdateCorpus.do')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
            ...
            <td ><table border="0" cellspacing="1" cellpadding="0" height="35">
                ...
                <tr>
                  ...
                  <td class="tableData" width="474" height="25" align="center"> <div align="left"> 
                      <html:text  property="corpusFromDate" size="20" maxlength="10"/><img src="images/CalendarIcon.gif" onclick="showCalendar('ifForm.corpusFromDate')" align="center">
                    </div></td>
                  <td width="360" class="ColumnBackground" height="25">
				  &nbsp;<bean:message key="corpusToDate" />
				  </td>
                  <td class="tableData" width="474" height="25" align="center"> <div align="left"> 
                      <html:text  property="corpusToDate" size="20" maxlength="10"/><img src="images/CalendarIcon.gif" onclick="showCalendar('ifForm.corpusToDate')" align="center">
                    </div></td>
                </tr>
              </table>
      </table></td>
  ...
  <tr> 
      ...
      <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
        <div>
          <div align="center"><html:link href="javascript:submitForm('showUpdateCorpusMaster.do?method=showCorpusList')"> <img src="images/Save.gif" alt="Ok" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Reset" width="49" height="37" border="0"></html:link></div>
      </div></td>
