...
<% session.setAttribute("CurrentPage","statementReportInput.do?method=statementReportInput");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="statementReport.do?method=statementReport" method="POST" enctype="multipart/form-data">
		<TR> 
	  ...
	  <TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpStatementReportDetails.do?method=helpStatementReportDetails')">
			    HELP</A>
			</DIV>
		</td>
	  </tr>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm('statementReport.do?method=statementReport')">
