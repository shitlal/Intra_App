...
<% session.setAttribute("CurrentPage","fdReceiptDetails.do?method=fdReceiptDetails");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="fdiReport.do?method=fdiReport" method="POST" enctype="multipart/form-data">
		<TR> 
...
%>
									<tr>
									<logic:iterate name="ifForm"  property="fdReceiptDetails"  id="object">
									<%
