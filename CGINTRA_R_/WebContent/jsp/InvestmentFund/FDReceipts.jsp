								...
								<TR>
									<TD colspan="12"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="24%" class="Heading"><bean:message key="ReceiptHeader" /></TD>
											...
											<tr>
											<logic:iterate name="ifForm" id="object" property="fdReport">
											<%
											...
											<% String mli = danReport.getBank(); 
											  String url = "fdReceiptDetails.do?method=fdReceiptDetails&number="+mli;%>
