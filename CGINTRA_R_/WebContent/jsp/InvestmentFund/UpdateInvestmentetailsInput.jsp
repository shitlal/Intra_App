...
<% session.setAttribute("CurrentPage","updateInvestmentDatailInput.do?method=updateInvestmentDatailInput");%>
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<tr> 
							  <td colspan="4">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR>
										<TD width="30%" class="Heading">Update Investment Details&nbsp;</TD>
							 ...
							 <tr align="left"> 
							   <td  class="ColumnBackground"> 
								...
								<td class="TableData">
									 <html:text property="investmentId" size="20" alt="investmentId" name="ifForm" maxlength="12"/>        
								</td>                 
							 </tr>
          	  </table>									
						</td>
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
								<A href="javascript:submitForm('displayInvestmentDetails.do?method=displayInvestmentDetails')"><IMG src="images/OK.gif" alt="Save" width="49" height="37" border="0"></A>	
