...
<% session.setAttribute("CurrentPage","fdDetailsForMaturity.do?method=fdDetailsForMaturity");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="fdDetailsForMaturity.do?method=fdDetailsForMaturity" method="POST" enctype="multipart/form-data">
		<TR> 
