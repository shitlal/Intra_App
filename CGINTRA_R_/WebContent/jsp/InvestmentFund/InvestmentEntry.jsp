...
<html:errors />
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<TR>
        ...
        <tr>
          ...
          <td class="ColumnBackground" colspan="3"><table><tr><td class="ColumnBackground" colspan="1"><bean:message key="years"/>&nbsp;&nbsp;
          <html:text  property="years" size="6"  maxlength="3" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)" /></td>
          <td class="ColumnBackground" colspan="1"><bean:message key="months"/>&nbsp;&nbsp;
          <html:text  property="months" size="6" maxlength="3" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)" /></td>
           <td class="ColumnBackground" colspan="1"><bean:message key="days"/>&nbsp;&nbsp;
           <html:text  property="days" size="6" maxlength="4" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)" /></td>
           </tr> </table></td>
        </tr>
        <tr>
 ...
 <tr>
					<td class="ColumnBackground"><div align="left">&nbsp;&nbsp;<font color="#FF0000" size="2">*</font>&nbsp;FD Receipt Number
					</div></td>
					<td class="tableData" colspan="2"><div align="left">
						<html:text  property="receiptNumber" /> 
					</div></td>
                </tr>
