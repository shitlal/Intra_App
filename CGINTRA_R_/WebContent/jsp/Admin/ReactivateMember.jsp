...
<% session.setAttribute("CurrentPage","showReactivateMem.do");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showReactivateMem.do" method="POST" focus="memberId">
		<TR> 
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpReactivateMember.do?method=helpReactivateMember')">
			    HELP</A>
			</DIV>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
								...
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="31%" class="Heading"><bean:message key="reactivateMemberHeader" /></TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('reactivateMem.do?method=reactivateMem')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
