...
<% session.setAttribute("CurrentPage","updateAccountDetail.do");%>
...
<html>
	...
	<body>
		<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
			<html:errors />
			<html:form action="updateAccountDetail.do" method="POST" focus="memberId">
				<TR> 
						...
						<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
										<TR>
											<TD colspan="4"> 
												<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
													<TR>											
														<TD width="31%" class="Heading">Modify Account Detail</TD>
										...
										<TR align="left">
											<TD align="left" colspan="4" valign="top" class="ColumnBackground">&nbsp;
												...
												<html:text property="memberId" size="20" maxlength="12" alt="memberId" name="regForm" onkeypress="javascript:return numbersOnly(this, event)" onkeyup="javascript:isValidNumber(this)"/>
											</TD>
										</TR>								
									</TABLE>
								</TD>
							...
							<TR >
								<TD align="center" valign="baseline" >
									<DIV align="center">								
										<A href="javascript:submitForm('updateAccount.do?method=updateAccount')">
