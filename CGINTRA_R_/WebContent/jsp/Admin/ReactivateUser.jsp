...
%>
<% session.setAttribute("CurrentPage","showReactivateUser.do?method=showReactivateUser");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
<html:errors />

<html:form action="showReactivateUser.do" method="POST" focus="<%=focusField%>">
...
<TR> 
		...
		<TR>
			...
			<td width="713">
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpReactivateUser.do?method=helpReactivateUser')">
			    HELP</A>
			</DIV>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading"><bean:message key="reactivateUserHeader" /></TD>
          ...
          <tr>
			...
			<html:select property="memberId" name="adminForm" onchange="javascript:submitForm('showReactivateUser.do?method=getInactiveUsersForMember')">
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">
										<html:select property="userId" name="adminForm">
											<html:option value="">Select</html:option>
											<html:options property="deactiveUsers" name="adminForm"/> 
										</html:select>
									</TD>
          </tr>
									<%
		  ...
		  <TR>
						...
						<td colspan="2" width="700"><DIV align="center">
							...
							<A href="javascript:submitForm('reactivateUser.do?method=reactivateUser')">
