...
%>
<% session.setAttribute("CurrentPage","showResetPassword.do?method=showResetPassword");%>
...
<HTML>
	<BODY>
		...
		<html:form action="showResetPassword.do" method="POST" focus="<%=focusField%>">
		...
		<TR> 
				...
				<TR>
					...
					<td width="713">
					<DIV align="right">			
					<A HREF="javascript:submitForm('helpResetPassword.do?method=helpResetPassword')">
					HELP</A>
					</DIV>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
				  ...
				  <tr> 
					<td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
														<TD width="31%" class="Heading"><bean:message key="resetPasswordHeader" /></TD>
			...
			<html:select property="memberId" name="adminForm" onchange="javascript:submitForm('showResetPassword.do?method=getUsersForMember')">
				  ...
				  <TD width="20%" align="left" valign="top" class="ColumnBackground">
				   ...
				   <TD width="27%" align="left" valign="top" class="TableData">
								...
								<td colspan="2" width="700"><DIV align="center">
										<A href="javascript:submitForm('resetPassword.do?method=resetPassword')">
