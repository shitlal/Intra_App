...
<% session.setAttribute("CurrentPage","showState.do?method=showState");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="addState.do" method="POST" focus="stateName">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
						<TD>
						<DIV align="right">			
				<A HREF="javascript:submitForm('helpState.do?method=helpState')">
			    HELP</A>
			</DIV>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
								...
								<TR align="left">
									<TD align="left" valign="top" class="ColumnBackground">
										&nbsp;<font color="#FF0000" size="2">*</font><bean:message key="stateName" />
									</TD>
									<TD align="left" class="TableData"> 
								...
								<TR align="left">
									...
									<TD align="left" class="TableData"> 
										<html:text property="stateCode" size="3" maxlength="3" alt="State code" name="adminForm"/>
									</TD>
								</TR>	
							</TABLE>
						</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('addState.do?method=addState')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>
