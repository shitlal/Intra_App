...
<% session.setAttribute("CurrentPage","addAccountDetail.do?method=addAccountDetail");%>
...
<head>
	...
	<BODY>
		<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
			<html:form action="saveAccDetail.do?method=saveAccDetail" method="POST">			
				<html:errors />
				<TR> 
						...
						<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<TD>
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
										...
										<TR>
											<TD colspan="4"> 
												<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
													<TR>
														<TD width="31%" class="Heading">Add Account Details</TD>
										...
										<TR align="left">
											...
											<TD align="left" class="TableData"> 
												<html:text property="memberId" maxlength="12" size="20" name="regForm" onkeypress="javascript:return isNumber (event)"/>
											</TD>
										</TR>		
										<TR align="left">
											<TD align="left" valign="top" class="ColumnBackground">&nbsp;
											...
											<TD align="left" class="TableData"> 
												<html:text property="phoneNo" name="regForm" />
											</TD>
										</TR>
										<TR align="left">
											<TD align="left" valign="top" class="ColumnBackground">&nbsp;
							...
							<TR >
								<TD align="center" valign="baseline" >
									<DIV align="center">
										<A href="javascript:submitForm('saveAccDetail.do?method=saveAccDetail')">
