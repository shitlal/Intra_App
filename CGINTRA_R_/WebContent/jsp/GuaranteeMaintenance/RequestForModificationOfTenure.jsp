						 ...
						 <logic:equal property="bankIdForClosure" value="0000" name="gmClosureForm">		
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData">
										<html:text property="memberIdForClosure" size="20" alt="MemberID"   onkeypress="return numbersOnly(this, event)"    maxlength ="12" name="gmClosureForm"/>
									</TD>
                  <TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font><bean:message key="cgpan"/>
									</TD>
									<TD align="left" valign="top" class="TableData">
									 <html:text property="cgpanForClosure" size="20" alt="CGPAN" name="gmClosureForm"  maxlength ="15" />
									</TD> 
								</TR>
						</logic:equal>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('getUnitForTenureRequest.do?method=getUnitForTenureRequest')">
