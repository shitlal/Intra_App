...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showClosureDetails.do?method=showClosureDetails" method="POST">
		<TR> 
...
<!--										<tr>
											...
											<logic:iterate id="aBid" name="gmForm" property="borrowerIds"> 	
												<%
												...
												<tr>
													<td class="ColumnBackground" height="24">
														<div align="center">
														<a href="modifyBorrowerDetailsForName.do?method=modifyBorrowerDetailsForName&bidName=<%=linkBid%>"><%=linkBid%>
														</a>
