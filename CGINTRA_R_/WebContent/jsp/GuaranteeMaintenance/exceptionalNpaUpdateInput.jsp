...
<% session.setAttribute("CurrentPage","exceptionalNpaUpdateInput.do?method=exceptionalNpaUpdateInput");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<!--			<A HREF="javascript:submitForm('helpClosureDetailsFilter.do?method=helpClosureDetailsFilter')">
			...
			<TD  align="left" colspan="4"><font size="2"><bold>
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory for Updation of NPA details for Exceptional Cases</bold></font>
			</td>
		</tr>
                  ...
                  <TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font><bean:message key="cgpan"/>
									...
									<TD align="left" valign="top" class="TableData">
									 <html:text property="cgpan" size="20" alt="CGPAN" name="gmPeriodicInfoForm"  maxlength ="15" />
									</TD> 
								</TR>
						</logic:equal>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('exceptionalNpaUpdate.do?method=exceptionalNpaUpdate')">
