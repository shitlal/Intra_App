...
<% session.setAttribute("CurrentPage","upgradationfromnpatostandard.do?method=upgradationfromnpatostandard");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="upgradationNpa.do?method=upgradationNpa" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
		<TR> 
	...
	<!--			<A HREF="javascript:submitForm('helpClosureDetailsFilter.do?method=helpClosureDetailsFilter')">
			...
			<TD  align="left" colspan="4"><font size="2"><bold>
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory for Upgradation of NPA to Standard</bold></font>
			</td>
		</tr>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('upgradationNpa.do?method=upgradationNpa')">
