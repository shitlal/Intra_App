...
<% session.setAttribute("CurrentPage","getIdForClosure.do?method=getIdForClosure");%>
...
<%focusField="borrowerIdForClosure";%>
</logic:notEqual>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showClosureDetails.do?method=showClosureDetails" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
		<TR> 
						 ...
						 <logic:notEqual property="bankIdForClosure" value="0000" name="gmPeriodicInfoForm">		
								...
								<TR>
									...
									<TD align="left" valign="top" class="TableData">
										<html:text property="borrowerIdForClosure" size="20" name="gmPeriodicInfoForm" maxlength ="9" />
										&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key = "or"/>
									</TD>
									<TD align="left" valign="top" class="ColumnBackground"><bean:message key="cgpan"/>
									</TD>
									<TD align="left" valign="top" class="TableData">
									 <html:text property="cgpanForClosure" size="20" alt="CGPAN" name="gmPeriodicInfoForm"  maxlength ="13" />
									</TD>
								</TR>
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData" colspan="4">
									<html:text property="borrowerNameForClosure"  size="30" alt="SSI Name" name="gmPeriodicInfoForm"/>
									</TD>
								</TR>  			
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showClosureDetails.do?method=showClosureDetails')">
