...
<% session.setAttribute("CurrentPage","getMemberForShiftingrequest.do?method=getMemberForShiftingrequest");%>
								...
								<tr align="left">
									<td class="ColumnBackground" width="207">
									 ...
									 <td class="TableData" width="343">
										<div align="left">
										  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										  <html:text property="selectMember" maxlength="12" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)" name="gmPeriodicInfoForm"/>
										</div>
									 </td>
								</tr>
							 </table>									
