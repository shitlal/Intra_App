...
%>
<%
	session.setAttribute("CurrentPage", "requestForRevivalInput.do");
%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="requestForRevival.do?method=requestForRevival"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="25%" class="Heading">&nbsp;Enter CGPAN</td>
											<td align="left" valign="bottom"><img
												src="images/TriangleSubhead.gif" width="19" height="19"></td>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="0">
										<tr>
											<td colspan="6" class="ColumnBackground"
												style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;CGPAN</td>
											<td class="TableData" style="text-align: center;">&nbsp;&nbsp;&nbsp;
											<html:text name="gmForm" property="cgpan" /></td>
										</tr>
									</table>
									</td>
								</tr>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('requestForRevival.do?method=requestForRevival')">
