...
<% session.setAttribute("CurrentPage","showModifyCollBank.do?method=showModifyCollBank");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showModifyCollBank.do" method="POST" focus="collectingBank">
		<TR> 
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpModifyDetails.do?method=helpModifyDetails')">
			    HELP</A>
			</DIV>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								...
								<A href="javascript:submitForm('modifyCollBank.do?method=modifyCollBank')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
