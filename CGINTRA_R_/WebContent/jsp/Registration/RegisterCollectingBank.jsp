...
<% session.setAttribute("CurrentPage","showRegCollBank.do?method=showRegCollBank");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="addCollBank.do" method="POST" focus="collectingBankName">
		<TR> 
		...
		<TR>
			...
			<TD>			
			<DIV align="right">			
				<A HREF="javascript:submitForm('helpRegCB.do?method=helpRegCB')">
			    HELP</A>
			</DIV>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left">
									...
									<TD align="left" class="TableData"> 
										<html:text property="collectingBankName" size="20" alt="Bank name" name="regForm" maxlength="100"/>
									</TD>
								</TR>

								<TR align="left">
									<TD align="left" valign="top" class="ColumnBackground">
										&nbsp;<font color="#FF0000" size="2">*</font><bean:message key="CBbranchName" />
									</TD>
									<TD align="left" class="TableData"> 
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('addCollBank.do?method=addCollBank')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>
