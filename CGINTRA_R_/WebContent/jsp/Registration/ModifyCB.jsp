...
<% session.setAttribute("CurrentPage","showModifyCB.do?method=showModifyCB");%>
...
<html:form action="showModifyCB.do" method="POST" focus="member">
...
<TR> 
		...
		<TR>
			...
			<td width="713">
			<DIV align="right">			
				<A HREF="javascript:submitForm('HelpShowModifyCB.do?method=HelpShowModifyCB')">
			    HELP</A>
			</DIV>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading"><bean:message key="modifyCBHeader" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp;<font color="#FF0000" size="2">*</font><bean:message key="member" />
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">
										<html:select property="member" name="regForm">
											<html:option value="">Select</html:option>
											<html:options property="cbMembers" name="regForm"/>			
										</html:select>
									</TD>
          </tr>
						...
						<td colspan="2" width="700"><DIV align="center">
								<A href="javascript:submitForm('modifyCB.do?method=modifyCB')">
