...
<% session.setAttribute("CurrentPage","agencyworkshopReport.do?method=agencyworkshopReport");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="agencyworkshopReport.do?method=agencyworkshopReport" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">Agency wise Scheme Propagation Report Details</TD>
               	...
               	<%
                      ...
                      <td align="left" valign="top" class="ColumnBackground1"><%=Integer.parseInt(index+"")+1%></td>
								       <TD width="10%" align="left" valign="top" class="ColumnBackground1">						
											...
											<%=bankName%> |	
											<%
                      String url1 = "agencymliworkshopReportNew.do?method=agencymliworkshopReportNew&state="+bankName;
                      String url2 = "agencystateworkshopReportNew.do?method=agencystateworkshopReportNew&state="+bankName;
									    String url3 = "agencypropagationworkshopReportNew.do?method=agencypropagationworkshopReportNew&state="+bankName;
                   %>
                    <html:link href="<%=url1%>">MLI wise</html:link> |<html:link href="<%=url2%>">State wise</html:link> |  <html:link href="<%=url3%>">Propagation wise</html:link>
                    <%	}
											%> 
               			</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('agencywiseWorkshopReportInput.do?method=agencywiseWorkshopReportInput')">
