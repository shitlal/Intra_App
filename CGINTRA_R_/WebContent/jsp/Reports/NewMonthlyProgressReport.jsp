   <%@ page language="java"%>
    ...
    <%  session.setAttribute("CurrentPage","newMonthlyReport.do?method=newMonthlyReport");%>
    <TABLE width="725" border="0" cellpadding="0" cellspacing="0">
      <html:errors/>
      <html:form action="newMonthlyReport.do?method=newMonthlyReport" method="POST" enctype="multipart/form-data">
        <TR>
        ...
        <TR>
          ...
          <TD>
            <DIV align="right">
              <A HREF="newMonthlyReportHelp.do?method=newMonthlyReportHelp">HELP</A> 
            </DIV>
            <TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <TR>
                      ...
                      <TD align="left" valign="center" class="TableData">
                        <DIV align="left">
                          <html:text property="dateOfTheDocument38" size="20" maxlength="10" alt="Reference" name="rsForm"/>
                          <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument38')" align="center"/>
                          <DIV align="left"/>
                        </DIV>
                      </TD>
                    ...
                    <TR>
									<TD align="left" valign="top" class="ColumnBackground">
									  ...
									  <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument39" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument39')" align="center">
										  <DIV align="left">
									  </TD>
									  </TR>
                    <TR>
              ...
              <TR>
                <TD align="center" valign="baseline">
                  <DIV align="center">
                    <A href="javascript:submitForm('newMonthlyProgressReport.do?method=newMonthlyProgressReport')">
