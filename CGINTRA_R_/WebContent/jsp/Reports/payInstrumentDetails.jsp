...
<% session.setAttribute("CurrentPage","payInstrumentDetails.do?method=payInstrumentDetails");%> 
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="payInstrumentDetails.do?method=payInstrumentDetails" method="POST" enctype="multipart/form-data">
		<TR> 
                  ...
                  <TD align="left" valign="top" class="ColumnBackground1">
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
							<A href="javascript:submitForm('paymentReport.do?method=paymentReport')">
