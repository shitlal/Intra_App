...
<% session.setAttribute("CurrentPage","propagationstateworkshopReportNew.do?method=propagationstateworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="propagationstateworkshopReportNew.do?method=propagationstateworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
