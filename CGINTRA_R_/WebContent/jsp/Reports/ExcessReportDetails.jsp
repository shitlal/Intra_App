...
<% session.setAttribute("CurrentPage","excessReportDetails.do?method=excessReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="excessReportDetails.do?method=excessReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
								...
								<TR>
									<TD colspan="12"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="40%" class="Heading"><bean:message key="excessInfoReport"/>&nbsp</TD>
