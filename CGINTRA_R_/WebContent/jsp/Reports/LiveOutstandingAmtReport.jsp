...
<% session.setAttribute("CurrentPage","coletralHybridRetailReportInput.do?method=LiveOutstandingReportInput");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReportInput.do?method=LiveOutstandingReportInput"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="30%" class="Heading">Live Outstanding Amount Report</TD>
									<td class="Heading" width="100%">&nbsp;<bean:message
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('coletralHybridRetailReportInput.do?method=LiveOutstandingReportInput')">
