...
<% session.setAttribute("CurrentPage","sectorDetailsForMli.do?method=sectorDetailsForMli");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="sectorDetailsForMli.do?method=sectorDetailsForMli" method="POST" enctype="multipart/form-data">
		<TR> 
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="sectorWiseReport">
									<%
