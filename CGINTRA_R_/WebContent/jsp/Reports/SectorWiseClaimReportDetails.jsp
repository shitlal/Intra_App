...
<% session.setAttribute("CurrentPage","sectorWiseClaimReportDetails.do?method=sectorWiseClaimReportDetails");%> 
               ...
               <tr>
                ...
                <tr>
								...
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="37%" class="Heading">Sector wise Claim Report Details </TD>
                  ...
                  <TD align="left" class="ColumnBackground"><bean:message key="proposals"/></TD>
  						  	<TD align="left" class="ColumnBackground">Claim Settled Amount (Rs. Lakh)</TD>
             			<%
                    int count       = 0;
										int totalCount  = 0;
										double sum      = 0.0;
                  ...
                  <%totalCount = count + totalCount;%>
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
							<A href="javascript:submitForm('sectorWiseClaimReport.do?method=sectorWiseClaimReport')">
