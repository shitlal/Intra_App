...
<%
	session.setAttribute("CurrentPage",
			"gfdanReport.do?method=gfdanReport");
%>
<%
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="gfdanReport.do?method=gfdanReport" method="POST"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TR>
								...
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included S & H Ecesskk</TD>
								<TD width="10%" align="left" valign="top"
							...
							<tr>
								<logic:iterate id="object" name="rsForm" property="gfdan"
									indexId="index">
									<%
									...
									<TR>
										...
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=dReport.getMemberId()%> <%
 ...
 %>
										...
										<%
											String danId = dReport.getDan();
													String url = "danReportDetails.do?method=danReportDetails&danValue="
															+ danId
															+ "&bankName="
															+ bank
															+ "&zoneName="
 ...
 %>
										...
										%> <%=decimalFormat.format(swbhart)%></div>
										</TD>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<TR>
							...
							<td align="left" valign="top" class="ColumnBackground">
							<div align="leftt">&nbsp;AAATC2613D</div>
							</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('gfdanReportInput.do?method=gfdanReportInput')">
