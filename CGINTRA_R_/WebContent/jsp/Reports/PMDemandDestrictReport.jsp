...
<% session.setAttribute("CurrentPage","coletralHybridRetailReportInput.do?method=PMDemandDestrictReportInput");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReportInput.do?method=PMDemandDestrictReportInput"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="30%" class="Heading">PM Demand Destrict Report</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('coletralHybridRetailReportInput.do?method=PMDemandDestrictReportInput')">
