...
<% session.setAttribute("CurrentPage","stateDetailsForState.do?method=stateDetailsForState");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateDetailsForState.do?method=stateDetailsForState" method="POST" enctype="multipart/form-data">
		<TR> 
