...
<% session.setAttribute("CurrentPage","statemliworkshopReportNew.do?method=statemliworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="statemliworkshopReportNew.do?method=statemliworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
