			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="35%" class="Heading"><bean:message key="danDetailsHeader" />&nbsp
												<%=value%>
												</TD>
                        <td class="Heading" width="40%">&nbsp;<bean:message key="from"/> <bean:write  name="rsForm" property="dateOfTheDocument2"/>&nbsp;<bean:message key="to"/> <bean:write  name="rsForm" property="dateOfTheDocument3"/></td>
									...
									<tr>
									<logic:iterate name="rsForm" id="object" property="danRaisedReport" indexId="index">
									<%
									...
									%>
									<TR>
									<TD	 align="left" valign="top" class="ColumnBackground1" colspan="7">	<%
