...
<% session.setAttribute("CurrentPage","sanctionedApplicationReportInput.do?method=sanctionedApplicationReportInput");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="sanctionedApplicationReport.do?method=sanctionedApplicationReport" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
			<A HREF="sanctionedApplicationReportHelp.do?method=sanctionedApplicationReportHelp">
			HELP</A>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm('sanctionedApplicationReport.do?method=sanctionedApplicationReport')">
