...
<%
	session.setAttribute("CurrentPage",
			"consolidatedDanReportInput.do?method=consolidatedDanReportInput");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="consolidatedDanReport.do?method=consolidatedDanReport"
		...
		<TR>
			...
			<TD>
			<DIV align="right"><A
				HREF="danReportHelp.do?method=danReportHelp"> HELP</A>
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TR>
								...
								<TD align="left" valign="middle" class="TableData" colspan="3">
									<!--<html:select property="reportType">
										<html:option value="WITHSTF">With ST Component & Flag</html:option>
										<html:option value="WITHOUTSTF">WithOut ST Component & Flag</html:option>
									</html:select>-->
							...
							<TR>
								...
								<DIV align="left">&nbsp;<b>Note: Service Tax on Fee Applicable w.e.f. 01/07/2012.</b>
								</DIV>
								</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('consolidatedDanReport.do?method=consolidatedDanReport')">
