...
<% session.setAttribute("CurrentPage","minorityReport.do?method=minorityReport");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="minorityReport.do?method=minorityReport" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<DIV align="right">			
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
                   ...
                   <A href="javascript:submitForm('minorityprogressReport.do?method=minorityprogressReport')">
