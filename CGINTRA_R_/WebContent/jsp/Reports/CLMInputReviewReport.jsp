...
<%
	session.setAttribute("CurrentPage","clmSettldReportReview.do?method=clmSettldReportReview");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="clmSettldReportReview.do?method=clmSettldReportReview"
						...
						<TR>
							...
							<TR>
								...
								<TR>
								   ...
								   <html:radio name="reportForm" value="Y" property="checkValue" >CLAIM PENDING</html:radio>&nbsp;&nbsp;
                                   <html:radio name="reportForm" value="N" property="checkValue" >CLAIM SETTLED DATE</html:radio>
                                   <html:radio name="reportForm" value="Y" property="checkValue" >ALL STATUS</html:radio>&nbsp;&nbsp;
                                   <html:radio name="reportForm" value="N" property="checkValue" >CGTUSER ID WISE</html:radio>
