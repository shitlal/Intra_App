...
<% session.setAttribute("CurrentPage","statewiseWorkshopReportInput.do?method=statewiseWorkshopReportInput");%>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('stateworkshopReport.do?method=stateworkshopReport')">
