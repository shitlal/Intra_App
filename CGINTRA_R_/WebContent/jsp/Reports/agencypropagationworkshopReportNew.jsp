...
<% session.setAttribute("CurrentPage","agencypropagationworkshopReportNew.do?method=agencypropagationworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="agencypropagationworkshopReportNew.do?method=agencypropagationworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
