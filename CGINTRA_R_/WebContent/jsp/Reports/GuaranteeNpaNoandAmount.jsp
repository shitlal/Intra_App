...
<% session.setAttribute("CurrentPage","npaAccountCountDetailsnew.do?method=npaAccountCountDetailsnew");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="npaAccountCountDetailsnew.do?method=npaAccountCountDetailsnew"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD class="Heading" width="60%">MLI Wise Guarantee Issued
									Vs NPA as on Guarantee Start Date</TD>
								</TR>
								<!--
           <td class="Heading" width="40%">&nbsp;<bean:message key="fromDate"/><bean:write  name="rsForm" property="dateOfTheDocument12"/>
    ...
    int totGarNInt = 0;
	int totNpaInt = 0;
    arraylist=(ArrayList)session.getAttribute("mliWiseGuarNpaNoAmtList");
   // String size=(String)session.getAttribute("datesListSize");
    //String size=(String)request.getAttribute("monthlyProgressReportArray_size");
    //int size=Integer.parseInt(strInt);
    ...
    %>
								<TR class="tableData">
									...
									<th class="ColumnBackground" colspan="1"
										style="text-align: center;">MLI</th>
      ...
      MonthlyStringArray=(String[])arraylist.get(count);
 	  ...
 	  %>
                    ...
                    String colname2=MonthlyStringArray[2];
									...
									totGarAmtCount=totGarAmtCount+Double.parseDouble(colname2);
          ...
          %>
								...
								<%  }
											...
											<tr>
									<TD align="right" valign="top" colspan="1" class="ColumnBackground">
									Total
									</TD>
									
				<td align="right" class="ColumnBackground">
									<div align="right">
									<%=String.valueOf(totGarNInt)%>
									</div>
									</TD>
									
									<TD align="right" class="ColumnBackground"> 
									<div align="right">
									<%=decimalFormat.format(totGarAmtCount)%>
									</div>
									</TD>
                  <TD align="right" class="ColumnBackground"> 
									<div align="right">
									<%=String.valueOf(totNpaInt)%>
									</div>
									</TD>
									<TD align="left" class="ColumnBackground"> 
									<div align="right">
									<%=decimalFormat.format(totNpaAmt)%>
									</div>
									</TD>
                  ...
                  <TD align="right" class="ColumnBackground"> 
									...
									<%=decimalFormat.format(totNpaNoPercent)%>
									</div>
									</TD>
									<TD align="left" class="ColumnBackground"> 
									<div align="right">
									...
									<%=decimalFormat.format(totNpaAmtGuarAmtPercent)%>
									</div>
									</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('npaAccountCount.do?method=npaAccountCount')">
