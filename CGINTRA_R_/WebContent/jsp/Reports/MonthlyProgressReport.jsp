...
<% session.setAttribute("CurrentPage","monthlyProgressReport.do?method=monthlyProgressReport");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="progressReport.do?method=progressReport" method="POST" enctype="multipart/form-data">
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
			<A HREF="monthlyProgressReportHelp.do?method=monthlyProgressReportHelp">
			HELP</A>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm('progressReport.do?method=progressReport')">
