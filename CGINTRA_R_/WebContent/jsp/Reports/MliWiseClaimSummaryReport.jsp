...
<% session.setAttribute("CurrentPage","mliWiseClaimSummaryReport.do?method=mliWiseClaimSummaryReport");%> 
                   ...
                   <logic:equal property="bankId" value="0000" name="rsForm">	
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('mliWiseClaimSummaryReportDetails.do?method=mliWiseClaimSummaryReportDetails')">
