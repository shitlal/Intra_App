...
<% session.setAttribute("CurrentPage","agencymliworkshopReportNew.do?method=agencymliworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="agencymliworkshopReportNew.do?method=agencymliworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
