...
<%
	session.setAttribute("CurrentPage",
			"coletralHybridRetailReport.do.do?method=RevivalHistoryReportDetail");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReport.do?method=RevivalHistoryReportDetail"
				...
				<TR>
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TD align="left" valign="top" class="ColumnBackground">
									<font color="#FF0000" size="2"></font> &nbsp;Mli Id
								</TD>
							<TD align="left" valign="middle" class="TableData">
 ...
 var Todate=document.forms[0].dateOfTheDocument21.value;
	if(Fromdate==''|| Todate==''){
          ...
          return false;	
			...
			document.forms[0].action= 'coletralHybridRetailReport.do?method=RevivalHistoryReportDetail';
