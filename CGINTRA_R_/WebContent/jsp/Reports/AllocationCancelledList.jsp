		...
		<TR>
			...
			<TD>
                ...
                <% com.cgtsi.reports.ApplicationReport dReport =  (com.cgtsi.reports.ApplicationReport)object;%> 
                  ...
                  <% String url = "rpCancelledReportDetails.do?method=rpCancelledReportDetails&payId="+dReport.getPayId(); %>
                   <html:link href="<%=url%>"><%= dReport.getPayId()%></html:link>
                     </TD>  
                     <TD  align="left" valign="top" class="ColumnBackground1">
                   <%=dReport.getDciAmountRaised() %>&nbsp;
                     </TD> 
                     <TD  align="left" valign="top" class="ColumnBackground1">
                   <%=dReport.getDdNum() %>&nbsp;
                     </TD>  
