		...
		<TR>
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <TD align="left" width="25%" valign="top" class="ColumnBackground">
                  ...
                  <TD align="left" valign="top" class="ColumnBackground1">
                      ...
                      %>
									...
									sum = amount/100000;%>
									<% totalSum = totalSum+Double.parseDouble(decimalFormat.format(amount));%>
                  ...
                  <TD align="left" class="ColumnBackground1"> 
									...
									<% prevtotalSum = prevtotalSum+Double.parseDouble(decimalFormat.format(prevamount));%>
                   ...
                   <TD align="left" class="ColumnBackground1"> 
									...
									<% cumtotalSum = cumtotalSum+Double.parseDouble(decimalFormat.format(cumamount));%>
								...
								<tr>
									...
									<TD align="left" class="ColumnBackground"> 
									<div align="right">
									<%=decimalFormat.format(totalSum/100000)%>
									</div>
									</TD>
                  <TD align="left" class="ColumnBackground"> 
									<div align="right">
									...
									<TD align="left" class="ColumnBackground"> 
									<div align="right">
									<%=decimalFormat.format(prevtotalSum/100000)%>
									</div>
									</TD>
                  <TD align="left" class="ColumnBackground"> 
									<div align="right">
									...
									<TD align="left" class="ColumnBackground"> 
									<div align="right">
									<%=decimalFormat.format(cumtotalSum/100000)%>
									</div>
									</TD>
								</tr>
