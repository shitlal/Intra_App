...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="afterFilterForPIReport.do?method=afterFilterForPIReport" method="POST" focus="memberId">
		<TR> 
		...
		<TR>
			...
			<TD>
			<!-- Fix bug 070904 - 16,17 -->  
			<DIV align="right">
			<A HREF="mliForReportHelp.do?method=mliForReportHelp">
			HELP</A>
				...
				<!-- Fix Completed-->
								...
								<tr align="left">
									<td class="ColumnBackground" width="207">
									 ...
									 <td class="TableData" width="343">
										<div align="left">
										  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										  <html:text property="memberId" size="20" alt="Select Member" name="rsPeriodicInfoForm" maxlength="12" />
										</div>
									 </td>
								</tr>
							 </table>									
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('afterFilterForPIReport.do?method=afterFilterForPIReport')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>					
				</TABLE>
