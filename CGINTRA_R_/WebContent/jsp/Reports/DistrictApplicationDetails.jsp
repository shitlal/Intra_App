<!-- JSP Modified by sudeep.dhiman@pathinfotech.com -->
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <tr> <td colspan="6">&nbsp;</td></tr>
											<TR>
												<TD width="19%" class="Heading"><bean:message key="districtHeader" /></TD>
                        <td class="Heading" width="35%"> <bean:message key="from"/><bean:write  name="rsForm" property="dateOfTheDocument10"/>&nbsp;<bean:message key="to"/> <bean:write  name="rsForm" property="dateOfTheDocument11"/></td>
                  ...
                  <TD align="left" valign="top" class="ColumnBackground">
								...
								<tr>
									<logic:iterate id="object" name="rsForm" property="districtReport" indexId="index">
									<%
