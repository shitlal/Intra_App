...
<%  session.setAttribute("CurrentPage","dailypaymentReport.do?method=dailypaymentReport");%>
<% SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%@ page import="java.text.DecimalFormat"%>
<% DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
  <html:errors/>
  <html:form action="dailypaymentReport.do?method=dailypaymentReport" method="POST" enctype="multipart/form-data">
    <TR>
        ...
        <TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                    ...
                    <TR>
                      ...
                      <TD width="20%" align="left" valign="top" class="ColumnBackground1">
                        <%    java.util.Date utilDate2=pReport.getRealisedDate();
                          ...
                          String url = "dailypaymentReportDetails.do?method=dailypaymentReportDetails&date="+formatedDate2+"&memId="+memberId;
          ...
          <TR>
            <TD align="center" valign="baseline" width="88%">
              <DIV align="center">
                <A href="javascript:submitForm('dailypaymentReportInput.do?method=dailypaymentReportInput')">
