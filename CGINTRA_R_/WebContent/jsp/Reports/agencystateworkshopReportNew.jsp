...
<% session.setAttribute("CurrentPage","agencystateworkshopReportNew.do?method=agencystateworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="agencystateworkshopReportNew.do?method=agencystateworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
