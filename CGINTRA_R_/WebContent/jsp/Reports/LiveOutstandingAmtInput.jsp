...
<%
	session.setAttribute("CurrentPage",
			"coletralHybridRetailReport.do.do?method=LiveOutstandingReportInput");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReport.do?method=LiveOutstandingReportDetails"
 ...
 var Todate=document.forms[0].dateOfTheDocument21.value;
	if(Fromdate==''|| Todate==''){
          ...
          return false;	
			...
			document.forms[0].action= 'coletralHybridRetailReport.do?method=LiveOutstandingReportDetails';
