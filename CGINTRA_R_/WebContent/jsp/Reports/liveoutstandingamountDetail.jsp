...
<% session.setAttribute("CurrentPage","liveoutstandingamountReportInput.do?method=liveoutstandingamountReportInput");%>
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="15%" class="Heading">Live Outstanding Report</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('liveoutstandingamountReportInput.do?method=liveoutstandingamountReportInput')">
