						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<DIV align="center">
									<font color="#FF0000" size="2">*</font>
								   <html:radio name="rsForm" value="yes" property="check" ><bean:message key="cgpan" /></html:radio>&nbsp;&nbsp;
                                    <html:radio name="rsForm" value="no" property="check" ><bean:message key="unitName" /></html:radio>
									</DIV>
									</TD>
									</TR>	
