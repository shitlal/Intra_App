...
<% session.setAttribute("CurrentPage","disbursementReportInput.do?method=disbursementReportInput");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="disbursementReport.do?method=disbursementReport" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
								...
								<TR>
									...
									<DIV align="center">
									   ...
									   <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument18" maxlength="10" size="20" name="rsForm" />
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('disbursementReport.do?method=disbursementReport')">
