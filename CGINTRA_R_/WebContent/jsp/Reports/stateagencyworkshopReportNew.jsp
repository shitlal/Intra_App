...
<% session.setAttribute("CurrentPage","stateagencyworkshopReportNew.do?method=stateagencyworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateagencyworkshopReportNew.do?method=stateagencyworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">Agency wise Report Details for <%=name%></TD>
