...
<% session.setAttribute("CurrentPage","stateworkshopReport.do?method=stateworkshopReport");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateworkshopReport.do?method=stateworkshopReport" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">State wise Scheme Propagation Report Details</TD>
                 ...
                 <TD width="10%" align="left" valign="top" class="ColumnBackground">
                  ...
                  %>
               	...
               	<%
                      ...
                      String url = "districtworkshopReportNew.do?method=districtworkshopReportNew&state="+bankName;
											...
											{
											%>
											<html:link href="<%=url%>"><%=bankName%> </html:link> 
										 |	
											<%
                      String url1 = "statemliworkshopReportNew.do?method=statemliworkshopReportNew&state="+bankName;
                      String url2 = "stateagencyworkshopReportNew.do?method=stateagencyworkshopReportNew&state="+bankName;
                      String url3 = "stateprogaramworkshopReportNew.do?method=stateprogaramworkshopReportNew&state="+bankName;
									 %>
                    <html:link href="<%=url1%>">MLIWise</html:link> | <html:link href="<%=url2%>">AgencyWise</html:link> | <html:link href="<%=url3%>">Scheme Propagation</html:link>
                    <%	}
											%> 
               			</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('statewiseWorkshopReportInput.do?method=statewiseWorkshopReportInput')">
