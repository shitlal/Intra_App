...
<%
	session.setAttribute("CurrentPage",
			"coletralHybridRetailReport.do.do?method=PMDemandDestrictReportInput");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReport.do?method=PMDemandDestrictReportDetails"
		...
		<TR>
				...
				<TR>
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TD align="left" valign="middle" class="TableData">
							<html:text property="cgpan" maxlength="15" ></html:text>
							</TD>
							<TD align="left" valign="top" class="ColumnBackground">
									<font color="#FF0000" size="2" maxlength="12" ></font> &nbsp;Mli Id
								</TD>
							<TD align="left" valign="middle" class="TableData">
							<html:text property="memberId" maxlength="12" ></html:text>
							</TD>
							</TR>
			...
			<DIV align="center">
			 	    <A onclick="Validatedate();">
					<IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>
			
		<!--  	<A href="javascript:submitForm('coletralHybridRetailReport.do?method=RevivalHistoryReportDetail')">
					<IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>-->
...
function Validatedate(){
 var Fromdate=document.forms[0].dateOfTheDocument20.value;
 var Todate=document.forms[0].dateOfTheDocument21.value;
	if(Fromdate==''|| Todate==''){
          alert("Please Select Date.");
          return false;	
		}else{

			document.forms[0].action= 'coletralHybridRetailReport.do?method=PMDemandDestrictReportDetails';
