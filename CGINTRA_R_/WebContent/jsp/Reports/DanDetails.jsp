...
<% session.setAttribute("CurrentPage","danDetails.do?method=danDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="danDetails.do?method=danDetails" method="POST" enctype="multipart/form-data">
		<TR> 
								...
								<TR>
									<TD colspan="12"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="40%" class="Heading"><bean:message key="cgpanHeader"/>&nbsp<%=value%></TD>
