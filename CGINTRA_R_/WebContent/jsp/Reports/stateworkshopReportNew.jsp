...
<% session.setAttribute("CurrentPage","stateworkshopReportNew.do?method=stateworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateworkshopReportNew.do?method=stateworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
