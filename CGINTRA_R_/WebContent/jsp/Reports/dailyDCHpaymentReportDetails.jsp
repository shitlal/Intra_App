...
<% session.setAttribute("CurrentPage","dailyDCHpaymentReportDetails.do?method=dailyDCHpaymentReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="dailyDCHpaymentReportDetails.do?method=dailyDCHpaymentReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD colspan="12"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
                          <td colspan="12" class="Heading1" align="center"><u><bean:message key="reportHeader"/></u></td>
                      </tr>
                      <tr> <td colspan="6">&nbsp;</td></tr>
                      
                      <TR>
												<TD width="18%" class="Heading"> DC (Handicrafts)&nbsp;  <bean:message key="paymentReportsHeader"/></TD>
                  ...
                  <TD width="20%" align="left" valign="top" class="ColumnBackground">
									...
									<tr>
									<logic:iterate name="rsForm"  property="dailydchpaymentDetails"  id="object" indexId="index">
									<%
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('dailydchpaymentReport.do?method=dailydchpaymentReport')">
