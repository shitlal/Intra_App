...
<% session.setAttribute("CurrentPage","dcHandicraftReport.do?method=dcHandicraftReport");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="dcHandicraftReport.do?method=dcHandicraftReport" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="18%" class="Heading">DC-Handicraft Report Details</TD>
                   ...
                   <TD width="10%" align="left" valign="top" class="ColumnBackground1">						
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('dcHandicraftInput.do?method=dcHandicraftInput')">
