...
<%
	session.setAttribute("CurrentPage",
			"asfpaymentReport.do?method=asfpaymentReport");
%>
<%
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfpaymentReport.do?method=asfpaymentReport"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="18%" class="Heading"><bean:message
										key="paymentReportsHeader" /></TD>
									<td class="Heading" width="40%">&nbsp;<bean:message
										key="from" /> <bean:write name="rsForm"
										property="dateOfTheDocument16" />&nbsp;<bean:message key="to" />
									<bean:write name="rsForm" property="dateOfTheDocument17" /></td>
							...
							<TR>
								...
								<TD width="10%" align="left" valign="top"
									...
									key="instrumentNumber" /></TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="paidDate" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message
									key="instrumentDate" /></TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="amountPaidRs" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message
									key="instrumentType" /></TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="modeOfPayment" />
								</TD>
								<TD width="15%" align="left" valign="top"
									class="ColumnBackground"><!-- <bean:message key="payeeBank"/> -->
								Payee Bank Name</TD>
								<TD width="20%" align="left" valign="top"
									class="ColumnBackground">Pay Drawn At Branch Name</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="payableAt" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message
									key="realisationDate" /></TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">
								<div align="right">Included S.B Ecess</div>
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">
							...
							<%
								double amount = 0;
									...
									double totalkrishikcess = 0;//kuldeep
							%>

							<tr>
								<logic:iterate name="rsForm" property="asfpayment" id="object"
									indexId="index">
									<%
									...
									<TR>
										...
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=pReport.getMemberId()%></TD>
 ...
 %>
										...
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=pReport.getPaymentMode()%>
										</TD>
										<TD width="15%" align="left" valign="top"
											class="ColumnBackground1">
										<%
 ...
 %>
										...
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=pReport.getPayableAt()%></TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<%
										...
										%> <%=decimalFormat.format(inclhSBecess)%></div>
										</TD>
								...
								<TR>
									...
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalAmount)%>
									</div>
									</TD>
									...
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalSBhecess)%>
									</div>
									</TD>
								
									<!--Added By kuldeep@path23-may-16-->
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
					...
					<TR>
						...
						<DIV align="center"><A
							href="javascript:submitForm('asfpaymentReportInput.do?method=asfpaymentReportInput')">
