...
<% session.setAttribute("CurrentPage","dailypaymentReportDetails.do?method=dailypaymentReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="dailypaymentReportDetails.do?method=dailypaymentReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
                  ...
                  <TD width="20%" align="left" valign="top" class="ColumnBackground">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('dailypaymentReport.do?method=dailypaymentReport')">
