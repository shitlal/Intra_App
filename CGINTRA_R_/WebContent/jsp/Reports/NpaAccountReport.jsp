...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="/npaAccountCount.do?method=/npaAccountCountDetails" enctype="multipart/form-data" method="POST">
		<TR> 
				...
				<TD  align="left" colspan="4"><font size="2"><bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm('/npaAccountCount.do?method=/npaAccountCountDetails')">
