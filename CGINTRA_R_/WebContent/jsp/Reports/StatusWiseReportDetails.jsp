				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												...
												<td class="Heading" width="45%">&nbsp;<bean:write name="radioValue"/>&nbsp;<bean:message key="from"/> <bean:write  name="rsForm" property="dateOfTheDocument14"/>&nbsp;<bean:message key="to"/> <bean:write  name="rsForm" property="dateOfTheDocument15"/></td>
