...
<% session.setAttribute("CurrentPage","inwardReportInput.do?method=inwardReportInput");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="inwardReportNew.do?method=inwardReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="18%" class="Heading">Inward Report Details</TD>
      ...
      <%String drawnonBank= danReport.getDrawnonBank();
        ...
        <TD width="10%" align="left" valign="top" class="ColumnBackground1">
       <%String assignedTo= danReport.getName();
       ...
       <TD width="10%" align="left" valign="top" class="ColumnBackground1">
       <%String outwardId= danReport.getAppRefNo();
       ...
       <TD width="10%" align="left" valign="top" class="ColumnBackground1">
       <% java.util.Date outwardDt = danReport.getDateOfTheDocument12();
          String outwardedDt = null;
          if(outwardDt !=null){
            outwardedDt=dateFormat.format(outwardDt);
          } else {
             outwardedDt = "";
          }          
       %> <%= outwardedDt%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('inwardReportInput.do?method=inwardReportInput'')">
