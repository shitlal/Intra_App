...
<% session.setAttribute("CurrentPage","stateDetailsForMli.do?method=stateDetailsForMli");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateDetailsForMli.do?method=stateDetailsForMli" method="POST" enctype="multipart/form-data">
		<TR> 
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									<logic:iterate id="object" name="rsForm" property="stateWiseReport">
									<%
									...
									String url = "districtDetailsForMli.do?method=districtDetailsForMli&state="+state;%>
										...
										String newUrl = "districtDetailsForMli.do?method=districtDetailsForMli&state="+newState;
										%>
