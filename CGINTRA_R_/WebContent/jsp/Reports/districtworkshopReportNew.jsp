...
<% session.setAttribute("CurrentPage","districtworkshopReportNew.do?method=districtworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="districtworkshopReportNew.do?method=districtworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">District wise Report Details for <%=name%></TD>
