...
<% session.setAttribute("CurrentPage","schemeworkshopReport.do?method=schemeworkshopReport");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="schemeworkshopReport.do?method=schemeworkshopReport" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">Propagation wise Scheme Propagation Report Details</TD>
               	...
               	<%
                      ...
                      <td align="left" valign="top" class="ColumnBackground1"><%=Integer.parseInt(index+"")+1%></td>
								       <TD width="10%" align="left" valign="top" class="ColumnBackground1">						
											...
											<%=bankName%> |	
											<%
                      String url1 = "propagationmliworkshopReportNew.do?method=propagationmliworkshopReportNew&state="+bankName;
                      String url2 = "propagationstateworkshopReportNew.do?method=propagationstateworkshopReportNew&state="+bankName;
									    String url3 = "propagationagencyworkshopReportNew.do?method=propagationagencyworkshopReportNew&state="+bankName;
                   %>
                    <html:link href="<%=url1%>">MLI wise</html:link> |<html:link href="<%=url2%>">State wise</html:link> |  <html:link href="<%=url3%>">Agency wise</html:link>
                    <%	}
											%> 
               			</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('schemewiseWorkshopReportInput.do?method=schemewiseWorkshopReportInput')">
