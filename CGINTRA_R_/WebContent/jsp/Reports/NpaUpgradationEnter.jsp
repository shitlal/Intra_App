...
<% session.setAttribute("CurrentPage","showNpaUpgradationEnter.do?method=showNpaUpgradationEnter");%>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
								...
								<TR>
									...
									<DIV align="center">
									   ...
									   <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument45" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument45')" align="center">
										  <DIV align="left">
									  </TD>
									...
									<font color="#FF0000" size="2">*</font>
									    ...
									    <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument46" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument45')" align="center">
										  <DIV align="left">
									  </TD>
									  </TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm('showNpaUpgradation.do?method=showNpaUpgradation')">
