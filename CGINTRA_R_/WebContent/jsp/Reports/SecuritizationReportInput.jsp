...
<% session.setAttribute("CurrentPage","securitizationReportInput.do?method=securitizationReportInput");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="securitizationReport.do?method=securitizationReport" method="POST" enctype="multipart/form-data">
		<TR> 
