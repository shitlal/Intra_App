...
<% session.setAttribute("CurrentPage","showFilterForSettlementReport.do?method=showFilterForSettlementReport");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="displaySettlementDetails.do?method=displaySettlementDetails" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<TD>
		        <DIV align="right">			
				<A HREF="javascript:submitForm('helpClaimSettlementReport.do')">
				HELP</A>
		        </DIV>        			
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm('displayMemberSettlementDtls.do?method=displayMemberSettlementDtls')">
