...
<%  session.setAttribute("CurrentPage","dailypaymentReportforRSF.do?method=dailypaymentReportforRSF");%>
<% SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%@ page import="java.text.DecimalFormat"%>
<% DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
  <html:errors/>
  <html:form action="dailypaymentReportforASF.do?method=dailypaymentReportforASF" method="POST" enctype="multipart/form-data">
    <TR>
        ...
        <TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <TD width="88%">
              <TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <TR>
                        <TD width="18%" class="Heading">
                          <bean:message key="paymentReportsHeader"/>
                        </TD>
                        <td class="Heading" width="40%">&nbsp;
                          <bean:message key="from"/>
                          <bean:write name="rsForm" property="dateOfTheDocument16"/>&nbsp;
                          <bean:message key="to"/>
                          <bean:write name="rsForm" property="dateOfTheDocument17"/>
                        </td>
                        <TD>
                ...
                <% 
									...
									%>
                <tr>
                  <logic:iterate name="rsForm" property="dailypayment" id="object" indexId="index">
                    <% 
                    ...
                    <TR>
                      ...
                      <TD width="20%" align="left" valign="top" class="ColumnBackground1">
                        <%    java.util.Date utilDate2=pReport.getRealisedDate();
                          ...
                          String url = "dailypaymentReportDetailsforASF.do?method=dailypaymentReportDetailsforASF&date="+formatedDate2+"&memId="+memberId;
          ...
          <TR>
            <TD align="center" valign="baseline" width="88%">
              <DIV align="center">
                <A href="javascript:submitForm('dailypaymentReportInputforASF.do?method=dailypaymentReportInputforASF')">
