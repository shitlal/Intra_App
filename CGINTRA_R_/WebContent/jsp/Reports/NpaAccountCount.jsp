...
<% session.setAttribute("CurrentPage","npaAccountCount.do?method=npaAccountCount");%> 

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="npaAccountCountDetailsnew.do?method=npaAccountCountDetailsnew" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('npaAccountCountDetailsnew.do?method=npaAccountCountDetailsnew')">
