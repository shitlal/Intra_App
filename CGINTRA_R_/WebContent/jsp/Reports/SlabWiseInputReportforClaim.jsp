...
<script>
 function selectDistrict()
 {
      ...
      document.forms[0].action              = "slabWiseClaimReport.do?method=slabWiseClaimReport";
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="slabWiseClaimReport.do" method="POST" enctype="multipart/form-data">
		<TR> 
                 ...
                 <TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('slabWiseClaimReportOutPut.do?method=slabWiseClaimReportOutPut')">
