...
<% session.setAttribute("CurrentPage","applicationHistoryReport.do?method=cgpanReductionEnhanceReport");%>
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('applicationHistoryReportDetails.do?method=cgpanReductionReportDetails ')">
