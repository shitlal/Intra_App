...
<% session.setAttribute("CurrentPage","turnoverandexport.do?method=turnoverandexport");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="turnoverandexport.do?method=turnoverandexport" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<DIV align="right">			
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
                   ...
                   <A href="javascript:submitForm('turnoverandexportsReport.do?method=turnoverandexportsReport')">
