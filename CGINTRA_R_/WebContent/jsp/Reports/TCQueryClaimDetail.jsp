...
<% session.setAttribute("CurrentPage","tcQueryClaimDetail.do?method=tcQueryClaimDetail");%>
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<TR>
									...
									<TD align="left" valign="top" class="ColumnBackground">
									 ...
									 <TD align="left" valign="center" class="TableData">
										 <html:text property="cgpan" size="20"  alt="Cgpan" maxlength="17" name="cpTcDetailsForm"/>  
									  </TD>
									  </TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitClaimDetailForm('displayTCQueryDetail.do?method=displayTCQueryDetail')">
