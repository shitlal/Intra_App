...
function submitForm1(action)
{
	 ...
	 var x;
		var items=document.getElementsByName('dantype');
		var cnt=0;
		...
		if(cnt<1)
		{
			alert("Please select dantype.");
			document.getElementsByName('dantype').focus();	
		}
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm1('asfallocatedpaymentReport.do?method=asfallocatedpaymentReport')">
