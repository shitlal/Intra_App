...
<% session.setAttribute("CurrentPage","rpCancelledReport.do?method=rpCancelledReport");%>
			...
			<DIV align="right">			
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <DIV align="center">
									 ...
									 <TD align="left" valign="center" class="ColumnBackground" colspan=3>
                   <DIV align="left">
										 <html:text property="payId" size="20"  alt="payId" maxlength="19" name="rsForm"/>  
									 </DIV>
                    </TD>
				           </TR>
								</TABLE>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('rpCancelledReportDetails.do?method=rpCancelledReportDetails')">
