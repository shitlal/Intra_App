...
<% session.setAttribute("CurrentPage","npaAccountCount_State.do?method=npaAccountCount_State");%> 

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="npaAccountCountDetailsnew_State.do?method=npaAccountCountDetailsnew_State" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('npaAccountCountDetailsnew_State.do?method=npaAccountCountDetailsnew_State')">
