...
<%@ include file="/jsp/SetMenuInfo.jsp" %>
 <% //session.setAttribute("CurrentPage","displayRRQueryDetail.do?method=displayRRQueryDetail");%>
 
 
<%-- <% session.setAttribute("CurrentPage","saveTcClaimProcessDetails.do?method=saveTcClaimProcessDetailsNew");%> --%>

<html:errors />
<html:form action="displayRRQueryDetail.do?method=displayRRQueryDetail" method="POST" enctype="multipart/form-data">
...
<td><table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
	...
	<tr>
	  <td width="35%" class="Heading">&nbsp;RR QUERY REPORT</td>
  ...
  <tr>
	...
	<tr class="HeadingBg">
		...
		<td><div align="center">&nbsp;Inward No</div></td>
		<td><div align="center">&nbsp;Inward Date</div></td>
	</tr>
  
	<%
	java.util.ArrayList rrqry=(java.util.ArrayList)request.getAttribute("danSummary");

    System.out.println("rrqry.size()....."+rrqry.size());
     for( int y=0;y<rrqry.size();y++)
        {
        String str[]=new String[5];
        
        str=(String [])rrqry.get(y);
    %>
        
	<tr class="TableData">
		<td><div align="center">&nbsp;<%=(y+1)%></div></td>
		<td><div align="center">&nbsp;<%=str[1]%></div></td>
		<td><div align="center">&nbsp;<%=str[0]%></div></td>
		<td><div align="center">&nbsp;<%=str[2]%></div></td>
		<td><div align="center">&nbsp;<%=str[3]%></div></td>
    </tr>
    <%  
       }
    %>
 ...
 <tr><td>
  ...
  <tr class="HeadingBg">
    ...
    <%
	java.util.ArrayList rcqry=(java.util.ArrayList)request.getAttribute("rrQuerySummary");

    int r=0;
    System.out.println("tcqry.size()....."+rcqry.size());
     for( int y=0;y<rcqry.size();y++)
        {
        String str[]=new String[19];
        
        str=(String [])rcqry.get(y);
