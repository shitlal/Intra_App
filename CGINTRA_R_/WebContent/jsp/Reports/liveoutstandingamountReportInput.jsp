...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="liveoutstandingamountReportInput.do?method=liveoutstandingamountReportInput"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('liveoutstandingamountReport.do?method=liveoutstandingamountReport')">
