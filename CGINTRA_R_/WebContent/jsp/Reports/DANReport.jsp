			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
							...
							<tr>
								<logic:iterate id="object" name="rsForm" property="dan"
									...
									<TR>
										...
										<%String cgpan=dReport.getCgpan(); %><%=cgpan%></TD>

										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<%String ssi=dReport.getSsi();	%> <%=ssi%></TD>
				...
				<tr>
					<td colspan="3" align="left" width="700"><font size="2"
						color="red">Report Generated On : <% java.util.Date loggedInTime=new java.util.Date();
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('danReportInput.do?method=danReportInput')">
