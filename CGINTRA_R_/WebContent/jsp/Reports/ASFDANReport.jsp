...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReport.do?method=asfdanReport" method="POST"
						...
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									...
									<bean:write name="rsForm" property="dateOfTheDocument21" /></td>
							...
							<TR>
								...
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="memberId" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Branch Name</TD>
								<!-- added by sukumar -->
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="cgpanNumber" />
								</TD>
								<TD width="10%" align="left" valign="top"
								...
								<!--            -->
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="daNumber" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="generatedDate" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="noOfAppls" />
								</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground"><bean:message key="danAmount" />
								</TD>
								...
								<%	double sum = 0;
										...
										double totalswbhart = 0;
										double totalkrishikcess=0;
									%>

								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included Service Tax</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included Ecess</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included S & H Ecess</TD>
								<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included SB Cess</TD>
									<TD width="10%" align="left" valign="top"
									class="ColumnBackground">Included Krishi Kalyan Cess</TD>
							</TR>

							<tr>
								<logic:iterate id="object" name="rsForm" property="asfdan"
									indexId="index">
									<%
									...
									<TR>
										...
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=dReport.getMemberId()%> <%String bank=dReport.getBank();
											String zone=dReport.getZone();
											String branch=dReport.getBranch();
String branchName = dReport.getBranchName();%> <%   java.util.Date utilDate=dReport.getDanDate();
										...
										<html:link href="<%=url%>"><%=danId%></html:link></TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1"><%=formatedDate%></TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<div align="right">
										<%count=dReport.getCount();
											   totalCount = totalCount + count;%> <%=count%></div>
										</TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<div align="right">
										...
										<% double inclSTax =dReport.getInclSTaxAmnt();
											   ...
											   %> <%=decimalFormat.format(inclSTax)%></div>
										</TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<div align="right">
										<%
											  ...
											  %> <%=decimalFormat.format(inclecess)%></div>
										</TD>
										<TD width="10%" align="left" valign="top"
											class="ColumnBackground1">
										<div align="right">
										<%
												...
												%> <%=decimalFormat.format(inclhecess)%></div>
										</TD>
										<TD width="10%" align="left" valign="top" class="ColumnBackground1">
											<div align="right">
												<%
													double swbhart = dReport.getSwBhaCessDed();
													totalswbhart = totalswbhart + swbhart;
												%>
												<%=decimalFormat.format(swbhart) %>
											</div>
										</TD>
								...
								<TR>
									...
									<div align="right"><%=totalCount%></div>
									</TD>
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalSum)%></div>
									</TD>

									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalst)%></div>
									</TD>
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalecess)%>
									</div>
									</TD>
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalhecess)%>
									</div>
									</TD>
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
									<div align="right"><%=decimalFormat.format(totalswbhart)%>
									</div>
									</TD>
									<TD width="10%" align="left" valign="top"
										class="ColumnBackground">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<TR>
							...
							<TD align="left" valign="top" class="ColumnBackground">
							<div align="leftt">&nbsp;AAATC2613DSD0001</div>
							</td>
							...
							<td align="left" valign="top" class="ColumnBackground">
							<div align="leftt">&nbsp;AAATC2613Dkk</div>
							</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('asfdanReportInput.do?method=asfdanReportInput')">
