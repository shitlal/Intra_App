<!-- added by sukumar@path for display MLI wise Claim Report Details -->
...
<% session.setAttribute("CurrentPage","mliWiseClaimReportDetails.do?method=mliWiseClaimReportDetails");%> 
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors/>
	<html:form action="mliWiseClaimReportDetails.do?method=mliWiseClaimReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
								...
								<TR>
									<TD colspan="8"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="37%" class="Heading">MLI wise Claim Report Details </TD>
                  ...
                  <TD align="left" class="ColumnBackground"> 
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
							<A href="javascript:submitForm('mliWiseClaimReport.do?method=mliWiseClaimReport')">
