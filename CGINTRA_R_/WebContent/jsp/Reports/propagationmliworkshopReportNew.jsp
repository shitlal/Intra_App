...
<% session.setAttribute("CurrentPage","propagationmliworkshopReportNew.do?method=propagationmliworkshopReportNew");%>
...
<TABLE width="800" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="propagationmliworkshopReportNew.do?method=propagationmliworkshopReportNew" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="45%" class="Heading">MLI wise Report Details for <%=name%></TD>
