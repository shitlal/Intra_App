...
<% session.setAttribute("CurrentPage","coletralHybridRetailReportInput.do?method=coletralHybridRetailReportInput");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="coletralHybridRetailReportInput.do?method=coletralHybridRetailReportInput"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="15%" class="Heading">Colletral Hybrid Retail Report</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('coletralHybridRetailReportInput.do?method=coletralHybridRetailReportInput')">
