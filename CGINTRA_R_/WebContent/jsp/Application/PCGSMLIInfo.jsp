...
<%  if(session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE).equals("PCGS"))
{
...
<html:errors />
<html:form action="afterPCGSMliPage.do?method=getPCGSApps" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('afterPCGSMliPage.do?method=getPCGSApps')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>					
				</TABLE>
