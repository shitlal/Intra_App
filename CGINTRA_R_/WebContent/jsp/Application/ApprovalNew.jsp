...
String splMessage="";			
    ...
    System.out.println("bankName name "+bankName);
        
      //  bankName = bankName + "$";
   // if(bankName.length() > 1){    
        bankName = bankName.replaceAll("PATH","&"); 
  //  }else{
  //      bankName = (String)request.getParameter("Link");
  //  }
...
<TR>
<TD colspan="14" class="Heading"><IMG src="images/Clear.gif" width="8" height="5"></TD>
</TR>
</TABLE>
</TD>
</TR>
            	...
            	<!--Eligible Non Duplicate Applications (Clear Applications)-->
                    ...
                    <td class="HeadingBg" align="center"><div align="center">Loan Type</div>
									  </td>	
                    ...
                    <td class="HeadingBg" align="center"><div align="center">Handicraft Flag</div>
                   <td class="HeadingBg" align="center"><div align="center">Handloom Flag</div>

									  </td> 
                    <td class="HeadingBg" align="center"><div align="center">Industry Nature</div>
									  </td> 
                    
                    <td class="HeadingBg" align="center"><div align="center">  Base Rate  / PLR  </div>
									  </td> 
					<td class="HeadingBg" align="center"><div align="center">Interest Rate Charged by Bank</div>
	...
	String handicratFlag=eligibleNonDupApplication.getHandiCrafts();
 String handloomFlag=eligibleNonDupApplication.getHandloomchk();						   
String appLoanType=eligibleNonDupApplication.getLoanType();
Double interest_rate=eligibleNonDupApplication.getINTEREST_RATE();
Double plr=eligibleNonDupApplication.getPLR();
...
double creditamount=0;
                ...
                <td class="tableData" align="center" width="10%">&nbsp;<%=appLoanType%></td>
                ...
                <td class="tableData" align="center" width="10%">&nbsp;<%=activity_new%></td> 
                  <td class="tableData" align="center" width="10%">&nbsp;<%=handicratFlag%></td>

                  <td class="tableData" align="center" width="10%">&nbsp;<%=handloomFlag%></td>  
                 <td class="tableData" align="center" width="10%">&nbsp;<%=industry_nature%></td> 
							
					<td class="tableData" align="center" width="10%">&nbsp;<%=plr%></td>
					<td class="tableData" align="center" width="10%">&nbsp;<%=interest_rate%></td>
					<td class="tableData" align="center" width="10%">&nbsp;</td>
					<td class="tableData" align="center" width="10%">&nbsp;</td>
                  ...
                  <!-- this scriptlet added by sudeep.dhiman@pathinfotech.com-->
                    ...
                    <%String hid="di"+k;%>
				       ...
				       <html:text property="<%=name%>" styleId="<%=id%>" alt="approvedAmt" name="apForm"  size="15" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" maxlength="16" disabled="true"/></div>
						  ...
						  <%
							...
							<tr>
								...
								<tr> 
								  ...
								  </td><td class="HeadingBg" align="center"><div align="center">Old SSI</div>
								  </td>
                  <td class="HeadingBg" align="center"><div align="center"><bean:message 	key="appLoanType"/></div>
								  </td>
								  <td class="HeadingBg" align="center"><div align="center"><bean:message 					key="newAppRefNo"/></div>
								  </td><td class="HeadingBg" align="center"><div align="center">New SSI</div>
								  </td>
                  <td class="HeadingBg" align="center"><div align="center"><bean:message 	key="appLoanType"/></div>
								  </td>
				...
				<td class="HeadingBg" align="center"><div align="center"> Base Rate  / PLR </div>
                  ...
                  <td class="HeadingBg" align="center"><div align="center"> Interest Rate Charged by Bank</div>
                    ...
                    <td class="HeadingBg" align="center"><div align="center">Activity Type </div>
									  </td>
                    <td class="HeadingBg" align="center"><div align="center"><bean:message key="zoneName"/></div>
									  </td>
								  <td class="HeadingBg" align="center"><div align="center"><bean:message key="decision"/></div>
                  ...
                  String prevLoanType = eligibleDupApplication.getPrevLoanType();
                  String existLoanType = eligibleDupApplication.getExistLoanType();
                  ...
                  String zoneName = eligibleDupApplication.getZoneName();
                   ...
                   String loanTypeNew  = eligibleDupApplication.getLoanType();
                  String handiflag = eligibleDupApplication.getHandicraftFlag();
                  String handloomFlag=eligibleDupApplication.getHandloomFlag();
                  String activityType = eligibleDupApplication.getActivityType();
    
									
String prevSsi = eligibleDupApplication.getPrevSSi();
                  String existSsi = eligibleDupApplication.getExistSSi();
                  
                  Double interest_rate=eligibleDupApplication.getINTEREST_RATE();
                  Double plr=eligibleDupApplication.getPLR();
...
<td class="tableData" align="center" rowspan="<%=jVal%>" width="10%"><%=prevSsi%></td>
               <td class="tableData" align="center" rowspan="<%=jVal%>" width="10%"><%=prevLoanType%></td>
            		<td class="tableData" align="center" rowspan="<%=jVal%>" width="10%">
	...
	<td class="tableData" align="center" rowspan="<%=jVal%>" width="10%"><%=existSsi%></td>
                <td class="tableData" align="center" rowspan="<%=jVal%>" width="10%"><%=existLoanType%></td>
								<%
    ...
    <td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=handiflag%>
								</td> 
<td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=handloomFlag%>
								</td>                 
<td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=nature%>
								</td>
								
<td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=plr%>
<td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=interest_rate%>
							
								
                <td class="tableData" align="center" rowspan="<%=jVal%>">&nbsp;<%=activityType%>
								...
								<TD align="center" valign="baseline" >
									<DIV align="center">
										<!--<A href="javascript:document.appForm.reset()">
											...
											**1294<IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>
