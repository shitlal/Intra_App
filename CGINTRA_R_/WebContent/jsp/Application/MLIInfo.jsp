	...
	<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
		...
		<TR>
			...
			<TD>
					...
					<TR>
						<TD>
							...
							<table width="661" border="0" cellspacing="1" cellpadding="1">
                                ...
                                <tr>
                                    <td>
                                        <!--<a href="createQuote.do?method=createQuote">Click here</a>
                                    --></td>
				...
				<tr><td>				
										<% 
										String ssi=request.getContextPath()+"/jsp/Reports/testReportPageInput.jsp";
										%>
                                        <a href="<%=ssi%>">Click here To Get SSI Detail</a>
                                    </td></tr>	
					<TR >
