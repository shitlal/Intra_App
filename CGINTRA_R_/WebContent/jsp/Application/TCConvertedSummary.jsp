...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="afterTcConversion.do?method=afterTcConversion" method="POST">
		<TR> 
						...
						<TD>
							...
							<%
								APForm apForm = (APForm)session.getAttribute("apForm");
								 if (apForm.getTcConvertedApplications().size()!=0)
								 {
							%>
							...
							<logic:iterate id="object" name="apForm" property="tcConvertedApplications">
								<% com.cgtsi.application.Application tcConverted = (com.cgtsi.application.Application)object;

								String appRefNo = tcConverted.getAppRefNo();
								String cgpan=tcConverted.getCgpan();
								%>
								<tr>
