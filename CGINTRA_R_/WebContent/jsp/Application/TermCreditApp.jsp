...
<html:form  action="addTermCreditApp.do?method=submitApp" method="POST" focus="<%=focusField%>">
					...
					<TR >
						...
						if (request.getParameter("detail")!=null)
							...
							<%}
								...
								<A href="javascript:submitForm('addTermCreditApp.do?method=submitApp')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>								
