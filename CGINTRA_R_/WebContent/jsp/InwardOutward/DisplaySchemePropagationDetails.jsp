...
function enableOfficerDetails() 
{
	...
	selectedOption = stateName.options[stateName.selectedIndex].value; 	 
  	...
  	url="displaySchemePropagationDetails.do?method=getDistricts&stateName="+stateName.value; 
...
<% 
  ...
  //System.out.println(dynaForm.get("districtName"));
  dynaForm.set("topic","CGTMSE Scheme");
%>

<body >
<html:form action="displaySchemePropagationDetails.do?method=displaySchemePropagationDetails" method="POST" enctype="multipart/form-data">
<html:errors />
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<TR>
        ...
        <TR align="left">
          ...
          <TD align="left" class="TableData" colspan="2">
						<html:select property="bankNames" name="ioForm">
							<html:option value="">Select</html:option>
							<html:options property="mliNames" name="ioForm"/>			
						</html:select>
      ...
      <%--  <tr>
        ...
        <TR align="left">
                ...
                <tr>
                  ...
                  <td class="tableData" colspan="2"><div align="left">
                    <html:text property="participants" name="ioForm" maxlength="6"  onkeypress="return numbersOnly(this, event)"/>
                  </div></td>
               </tr>
               ...
               <tr>
                  ...
                  <td class="tableData" colspan="2"><div align="left">
                    <html:text property="name" name="ioForm" maxlength="100"/>
                  </div></td>
               </tr>
            ...
            <%--   <tr>
                ...
                <tr>
                  ...
                  <td class="tableData" colspan="2"><div align="left">
                    <html:text property="organisation" name="ioForm" maxlength="100"/>
                  </div></td>
               </tr>
          ...
          <tr > 
            <td align="center" valign="baseline" > <div align="center"><html:link href="javascript:submitForm('displaySchemePropagationDetails.do?method=afterUpdateSchemePropagationDtls')"><img src="images/Save.gif" alt="Save" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Cancel" width="49" height="37" border="0"></html:link> 
              </div></td>
          </tr>
        </table></td>
