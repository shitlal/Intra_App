...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="updateInwardDetails.do?method=updateInwardDetails" method="POST" enctype="multipart/form-data">
		<TR> 
							...
							<tr> 
							  <td colspan="4">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR>
										<TD width="30%" class="Heading">Update Inward Details&nbsp;</TD>
                 ...
                 <td  class="ColumnBackground"> 
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
								<A href="javascript:submitForm('displayInwardDetails.do?method=displayInwardDetails')"><IMG src="images/OK.gif" alt="Save" width="49" height="37" border="0"></A>	
