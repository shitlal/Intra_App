...
<% session.setAttribute("CurrentPage","addCreditTXNFile.do?method=addCreditTXNFile");%>
...
<html:form action="insertInwardTXNFileData.do?method=insertInwardTXNFileData" method="POST" enctype="multipart/form-data">
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
								...
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<TR>
												<TD colspan="3" class="Heading"><html:file property="filePath" name="ioForm" /></TD>
											</TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('insertInwardTXNFileData.do?method=insertInwardTXNFileData')">
