...
<% session.setAttribute("CurrentPage","documentDetailsOutward1.do?method=documentDetailsOutward1");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="documentDetailsOutward1.do?method=documentDetailsOutward1" method="POST" enctype="multipart/form-data">
		<TR> 
