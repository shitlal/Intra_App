...
<% session.setAttribute("CurrentPage","documentDetailsInward.do?method=documentDetailsInward");%>


<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="documentDetailsInward.do?method=documentDetailsInward" method="POST" enctype="multipart/form-data">
		<TR> 
