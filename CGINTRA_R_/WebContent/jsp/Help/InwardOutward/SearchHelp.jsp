...
<% session.setAttribute("CurrentPage","searchHelp.do");%>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
			Enter Remarks 
						...
						<DIV align="center">
						<!-- To fix bug 07092004-02 -->
						 <A href="javascript:submitForm('searchDocument.do?method=searchDocument')">
						 <!-- Fix is completed. -->
