...
<% session.setAttribute("CurrentPage","defaultRateHelp.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter the Date for which the Default Rate Report is to be generated. 
		  </TD>
          </tr>
						...
						<DIV align="center">
						<A href="defaultRateReportInput.do?method=defaultRateReportInput">
