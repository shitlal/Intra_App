...
<% session.setAttribute("CurrentPage","helpMiscReceipts.do");%>
...
<TR> 
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select whether this amount should be considered for investment.
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						...
						<DIV align="center">
						<a href="javascript:submitForm('showMiscReceipts.do?method=showMiscReceipts');">
