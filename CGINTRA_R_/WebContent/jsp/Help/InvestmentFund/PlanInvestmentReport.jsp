...
<% session.setAttribute("CurrentPage","helpPlanInvReport.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="InflowOutflowDetails" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter the Date for which Plan Investment Report needs to be viewed.
		  </TD>
          </tr>
						...
						<DIV align="center">
						<A href="javascript:submitForm('showInflowOutflowReportInput.do?method=showInflowOutflowReportInput')">
