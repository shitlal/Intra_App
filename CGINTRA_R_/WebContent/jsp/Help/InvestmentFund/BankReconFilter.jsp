...
<% session.setAttribute("CurrentPage","helpBankReconFilter.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Date for which Bank Reconciliation Report has to be generated.
		  </TD>
          </tr>
						...
						<DIV align="center">
						 <A href="javascript:submitForm('showBankReconFilter.do?method=showBankReconFilter')">
