...
<% session.setAttribute("CurrentPage","helpInvesteeGroupMaster.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="InvesteeGroupDetails" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp; <bean:message key="selInvesteeGrp"/>
										</DIV>
									</TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp; <bean:message key="newInvesteeGrp"/>
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										<bean:message key="newInvesteeGrp"/>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp; <bean:message key="modInvesteeGrp"/>
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										<bean:message key="modInvesteeGrp"/>
