...
<% session.setAttribute("CurrentPage","helpFundTransferFilter.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Date for Fund Transfers are to be entered.
		  </TD>
          </tr>
						...
						<DIV align="center">
						<A href="javascript:submitForm('showFundTransferFilter.do?method=showFundTransferFilter')">
