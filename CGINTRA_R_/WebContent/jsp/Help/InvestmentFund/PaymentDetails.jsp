...
<% session.setAttribute("CurrentPage","helpPaymentDetails.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter the date from which the details should be displayed.
		  </TD>
          </tr>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter the date till which the details are to be displayed.
		  </TD>
          </tr>
