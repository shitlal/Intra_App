...
<% session.setAttribute("CurrentPage","helpAccruedInterestIncomeReport.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter a value for date to display the report. 
		  </TD>
          </tr>
						...
						<DIV align="center">
						<A href="accruedInterestIncomeReportInput.do?method=accruedInterestIncomeReportInput">
