...
<% session.setAttribute("CurrentPage","helpAnnualFundsOutflowDetails.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the date on which outflow fund details should be entered. By clicking on 'Get Outflow Details', the user can view the Outflow details
		  </TD>
          </tr>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Budget Head outflow fund values.
		  </TD>
          </tr>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Budget Sub-Head outflow fund values.
		  </TD>
          </tr>
