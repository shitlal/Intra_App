...
<% session.setAttribute("CurrentPage","helpRatingMaster.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="ratingDetails" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the description of the rating.
		  </TD>
          </tr>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the agency which gave the rating.
		  </TD>
          </tr>
