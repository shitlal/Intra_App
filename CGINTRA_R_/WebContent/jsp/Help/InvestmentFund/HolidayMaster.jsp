...
<% session.setAttribute("CurrentPage","helpHolidayMaster.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="holidayDetailsHeading" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp; <bean:message key="newHolidayDate"/>
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										<bean:message key="newHolidayDate"/>
	  		  ...
	  		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
	  										<DIV align="left">
	  											&nbsp; <bean:message key="modHolidayDate"/>
	  										</DIV>
	  									</TD>
	             <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
	  										<bean:message key="modHolidayDate"/>
