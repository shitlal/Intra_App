...
<% session.setAttribute("CurrentPage","helpStatementReportDetails.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="danReportHeader" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
												Enter the statement date to display the report. 
		  </TD>
          </tr>
						...
						<DIV align="center">
						<A href="statementReportInput.do?method=statementReportInput">
