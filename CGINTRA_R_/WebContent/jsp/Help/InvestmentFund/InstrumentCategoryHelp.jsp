...
<% session.setAttribute("CurrentPage","helpInstrumentCatMaster.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
									<TD width="31%" class="Heading"><bean:message key="instCategoryDtls" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the Instrument Category to be modified
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp; Enter New Instrument Category
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter New Instrument Category Name
		  </TD>
          </tr>
                    <tr>
	  		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
	             ...
	             <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
	  										Enter Instrument Category Description
	  		  </TD>
          </tr>		  
