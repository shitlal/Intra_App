...
<% session.setAttribute("CurrentPage","helpAnnualFundsInflowDetails.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the date on which inflow fund details should be entered. By clicking on 'Get Inflow Details', the user can view the inflow details
		  </TD>
          </tr>
		   <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Budget head inflow fund values.
		  </TD>
          </tr>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter the Budget sub-head inflow fund values.
		  </TD>
          </tr>
