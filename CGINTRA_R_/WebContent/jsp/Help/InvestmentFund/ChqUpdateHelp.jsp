...
<% session.setAttribute("CurrentPage","chqUpdateHelp.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
			Select the bank name for which the cheque leaves have to be updated.
			</TD>
          </tr>
						...
						<DIV align="center">
						 <A href="javascript:submitForm('showDtlsForChqLeavesUpdate.do?method=showDtlsForChqLeavesUpdate')">
