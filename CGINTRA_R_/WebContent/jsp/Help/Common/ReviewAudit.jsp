...
<% session.setAttribute("CurrentPage","helpReviewAudit.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						...
						Enter the CGPAN and click GET DETAILS to view the Audit comments <BR>&nbsp;for that CGPAN. 
		  </TD>
          </tr>	
		   <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					...
					The latest  Audit comment will be displayed.
		  </TD>
          </tr>	
		  <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					...
					The audit comment entered before the latest  Audit comment will be<BR>&nbsp; displayed.
		  </TD>
          </tr>		
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					...
					The audit comment viewed immediately before the present comment<BR>&nbsp; will be displayed.
		  </TD>
          </tr>		
