...
<% session.setAttribute("CurrentPage","helpEnterAudit.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										...
										Enter the CGPAN for which the Audit Details is to be entered.
		  </TD>
          </tr>	
		   <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						...
						Enter Audit comments about anything giving references<BR>&nbsp;
						(for eg: if audit comments about any application,enter CGPAN,<BR>&nbsp;
						if audit comments about DAN,then enter DAN reference no.) 
		  </TD>
          </tr>		
