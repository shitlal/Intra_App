...
<% session.setAttribute("CurrentPage","HelpException.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
									Select an already existing exception title or enter a new exception title.
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter a message for the Exception.
		  </TD>
          </tr>	
		  <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select a Type for the Exception Title.
		  </TD>
          </tr>	
						...
						<DIV align="center">
						<A  HREF="javascript:submitForm('showExceptionMessages.do?method=showExceptionMessages')">	
