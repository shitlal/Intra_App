...
<% session.setAttribute("CurrentPage","helpDayEndProcesses.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox if data entered by Demo is to be removed&nbsp;&nbsp;User.
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to move the data which does not require CGTSI &nbsp;&nbsp;approval.
		  </TD>
          </tr> 
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to close loans at tenure end date.
		  </TD>
          </tr> 
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to generate SFDan.
		  </TD>
          </tr> 
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to generate CGDan.
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to generate CLDan.
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to generate Short DAN.
		  </TD>
          </tr>   
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to calculate Penalty.
		  </TD>
          </tr> 
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select the checkbox to move Batch Process.
		  </TD>
          </tr>                              
		   <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										On clicking submit the selected day end processes will be performed.
		  </TD>
          </tr>
