					 ...
					 <tr>
						  <TD width="20%" align="left" valign="top" class="ColumnBackground">
						   ...
						   <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
								...
								Approved Amount has to be entered when the decision for an application is chosen as 'Accept' or 'WC Enhancement'.
							</TD>
					</tr>
					 <tr>
						  <TD width="20%" align="left" valign="top" class="ColumnBackground">
						   ...
						   <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
								Enter the comments for the application.Comments is mandatory if decision taken is 'Hold' or 'Reject'.
							</TD>
					</tr>
				</table>
