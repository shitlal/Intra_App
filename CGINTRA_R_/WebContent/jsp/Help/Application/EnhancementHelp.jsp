...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
 <tr>
	  <TD width="20%" align="left" valign="top" class="ColumnBackground" colspan="2">
									<DIV align="left">
										&nbsp;
								Application and Borrower Details cannot be modified.
									</DIV>
								</TD>
</tr>
<tr>
...
<tr>
 ...
 <tr>
	  <TD width="20%" align="left" valign="top" class="ColumnBackground" colspan="2">
									<DIV align="left">
										&nbsp;
								Working Capital Enhancement Details
									</DIV>
								</TD>
</tr>
<tr>
...
<tr>
	  <TD width="20%" align="left" valign="top" class="ColumnBackground">
	   ...
	   <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					Enter the date on which the application is enhanced.
					</TD>
</tr>
<tr>
	  <TD width="20%" align="left" valign="top" class="ColumnBackground">
	   ...
	   <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					Enter any remarks for the enhancement of the application.
					</TD>
</tr>
</table>
