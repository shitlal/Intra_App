...
<% session.setAttribute("CurrentPage","helpProcessOTSDetails.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading">OTS Process Info</TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Decision taken by CGTSI for this OTS Application. <br>&nbsp;&nbsp;The User may view OTS Details as submitted during filing of the OTS &nbsp;&nbsp;Request by clicking on the Borrower Id.
		  </TD>
          </tr>
		   <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Remarks for this OTS Application.
		  </TD>
          </tr>
