...
<% session.setAttribute("CurrentPage","helpEnterMemIdBIdCGPAN.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading">Download Export File</TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp; Click on the link to download the Exported Claim File to your Local &nbsp;&nbsp;Machine
