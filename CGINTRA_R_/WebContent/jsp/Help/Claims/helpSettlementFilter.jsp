...
<% session.setAttribute("CurrentPage","displaySettlementDetailFilter.do?method=displaySettlementDetailFilter");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading">Settlement Filter Detail</TD>
