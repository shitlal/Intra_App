		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading">ITPAN Detail</TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Please enter ITPAN of Chief Promoter in the correct format:<br> The correct format is : cccccnnnnc where 'c' stands for a Character and 'n' stands for a Digit.
		  </TD>
          </tr>		   		  		  		  		  		  		 		  
