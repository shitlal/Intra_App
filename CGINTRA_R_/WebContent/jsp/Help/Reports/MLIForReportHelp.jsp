...
<% session.setAttribute("CurrentPage","mliForReportHelp.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Enter a value for the Member ID
		  </TD>
          </tr>
							<TR align="center" valign="baseline" >
						<td colspan="2" width="700">
						<DIV align="center">
						<A href="javascript:submitForm('showFilterForPIReport.do?method=showFilterForPIReport')">
