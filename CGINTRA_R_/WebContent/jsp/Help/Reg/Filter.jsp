...
<% session.setAttribute("CurrentPage","helpFilter.do");%>
		...
		<TR>
          ...
          <tr> 
            <td colspan="2" width="700"><table width="604" border="0" cellspacing="0" cellpadding="0">
												<TD width="31%" class="Heading"><bean:message key="filterScreenHeader" /></TD>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						Enter the member Id for which the organisation structure is to be<BR>&nbsp; defined. 	
		  </TD>
          </tr>          
