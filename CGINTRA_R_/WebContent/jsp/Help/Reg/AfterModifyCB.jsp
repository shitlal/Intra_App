...
<% session.setAttribute("CurrentPage","HelpAfterModifyCB.do");%>
...
<TR> 
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
										<DIV align="left">
											&nbsp;Present Collecting Bank	
										</DIV>
									</TD>
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						The collecting bank already assigned for the member is displayed.
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
				Enter a new collecting bank for the member chosen.
