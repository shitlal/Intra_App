...
<% session.setAttribute("CurrentPage","HelpAssignCB.do");%>
		...
		<TR>
		  ...
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
						Select the Member Banks for whom the Collecting Bank is to be<BR>&nbsp; assigned.
						More than one bank can be chosen.			
		  </TD>
          </tr>
          <tr>
		  <TD width="20%" align="left" valign="top" class="ColumnBackground">
           ...
           <TD width="27%" align="left" valign="top" class="TableData">&nbsp;
										Select a collecting Bank for the Members chosen.
		  </TD>
          </tr>	  
